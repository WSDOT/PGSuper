...
void CTOGAGirderSelectStrandsDlg::InitializeData(SpanIndexType span, GirderIndexType girder,
                     ...
                     const std::vector<CDebondInfo>& straightDebond, 
...
bool CTOGAGirderSelectStrandsDlg::GetData(DirectStrandFillCollection& directFilledStraightStrands,
                                          std::vector<CDebondInfo>& straightDebond)
{
...
void CTOGAGirderSelectStrandsDlg::OnHelp()
{
   ...
   ::HtmlHelp( *this, pApp->m_pszHelpFilePath, HH_HELP_CONTEXT, IDH_GIRDER_DIRECT_STRAND_FILL );
}
