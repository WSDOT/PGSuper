========================================================================
    ACTIVE TEMPLATE LIBRARY : TxDOTAgent Project Overview
========================================================================

AppWizard has created this TxDOTAgent project for you to use as the starting point for
...
TxDOTAgent.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (TxDOTAgent.h)
        GUID definitions                                (TxDOTAgent_i.c)
        A type library                                  (TxDOTAgent.tlb)
        Marshaling code                                 (TxDOTAgent_p.c and dlldata.c)

TxDOTAgent.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in TxDOTAgent.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named TxDOTAgent.pch and a precompiled types file named StdAfx.obj.
...
TxDOTAgentps.vcproj
	...
	dlldata.c, TxDOTAgent_i.c and TxDOTAgent_p.c which are required
