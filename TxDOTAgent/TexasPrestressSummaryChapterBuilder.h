...
private:
   ...
   CTexasPrestressSummaryChapterBuilder(const CTexasPrestressSummaryChapterBuilder&);
   CTexasPrestressSummaryChapterBuilder& operator=(const CTexasPrestressSummaryChapterBuilder&);
