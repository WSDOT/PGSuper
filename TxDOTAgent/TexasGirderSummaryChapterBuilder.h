...
private:
   ...
   CTexasGirderSummaryChapterBuilder(const CTexasGirderSummaryChapterBuilder&);
   CTexasGirderSummaryChapterBuilder& operator=(const CTexasGirderSummaryChapterBuilder&);
