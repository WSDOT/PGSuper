...
std::shared_ptr<WBFL::ReportMgr::ReportSpecification> CCopyPierPropertiesReportSpecificationBuilder::CreateReportSpec(const WBFL::ReportMgr::ReportDescription& rptDesc, std::shared_ptr<WBFL::ReportMgr::ReportSpecification> pOldRptSpec) const
{
...
std::shared_ptr<WBFL::ReportMgr::ReportSpecification> CCopyPierPropertiesReportSpecificationBuilder::CreateDefaultReportSpec(const WBFL::ReportMgr::ReportDescription& rptDesc) const
{
   // Use all chapters at the maximum level
   std::shared_ptr<WBFL::ReportMgr::ReportSpecification> pRptSpec(std::make_shared<CCopyPierPropertiesReportSpecification>(rptDesc.GetReportName(), m_pBroker));
