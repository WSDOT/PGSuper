...
CMultiGirderReportDlg::CMultiGirderReportDlg(std::shared_ptr<WBFL::EAF::Broker> pBroker,const WBFL::ReportMgr::ReportDescription& rptDesc,std::shared_ptr<WBFL::ReportMgr::ReportSpecification> pRptSpec,UINT nIDTemplate,CWnd* pParent)
...
{
   EAFHelp( EAFGetDocument()->GetDocumentationSetName(), IDH_MULTIGIRDER_REPORT );
}
