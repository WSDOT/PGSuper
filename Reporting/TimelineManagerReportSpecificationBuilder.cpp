...
std::shared_ptr<WBFL::ReportMgr::ReportSpecification> CTimelineManagerReportSpecificationBuilder::CreateReportSpec(const WBFL::ReportMgr::ReportDescription& rptDesc, std::shared_ptr<WBFL::ReportMgr::ReportSpecification> pOldRptSpec) const
{
...
std::shared_ptr<WBFL::ReportMgr::ReportSpecification> CTimelineManagerReportSpecificationBuilder::CreateDefaultReportSpec(const WBFL::ReportMgr::ReportDescription& rptDesc) const
{
   // Use all chapters at the maximum level
   std::shared_ptr<WBFL::ReportMgr::ReportSpecification> pRptSpec(std::make_shared<CTimelineManagerReportSpecification>(rptDesc.GetReportName(), m_pBroker));
