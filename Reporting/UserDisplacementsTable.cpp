                                              ...
                                              IEAFDisplayUnits* pDisplayUnits) const
{
   ...
   for ( GroupIndexType grpIdx = startGroupIdx; grpIdx <= endGroupIdx; grpIdx++ )
   {
      ...
      maxDC2 = pForces2->GetDisplacement( compositeDeckIntervalIdx, pftUserDC, vPoi, maxBAT );
      minDC2 = pForces2->GetDisplacement( compositeDeckIntervalIdx, pftUserDC, vPoi, minBAT );
      ...
      maxDW2 = pForces2->GetDisplacement( compositeDeckIntervalIdx, pftUserDW, vPoi, maxBAT );
      minDW2 = pForces2->GetDisplacement( compositeDeckIntervalIdx, pftUserDW, vPoi, minBAT );
