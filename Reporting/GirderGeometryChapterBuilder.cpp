...
void girder_points(IBroker* pBroker,IDisplayUnits* pDispUnit,rptChapter* pChapter);
void girder_offsets(IBroker* pBroker,IDisplayUnits* pDispUnit,rptChapter* pChapter);
void girder_spacing(IBroker* pBroker,IDisplayUnits* pDispUnit,rptChapter* pChapter);
void girder_ends(IBroker* pBroker,IDisplayUnits* pDispUnit,rptChapter* pChapter);
void girder_lengths(IBroker* pBroker,IDisplayUnits* pDispUnit,rptChapter* pChapter);
...
rptChapter* CGirderGeometryChapterBuilder::Build(CReportSpecification* pRptSpec,Uint16 level) const
{
   ...
   girder_points(pBroker,pDispUnit,pChapter);
   girder_offsets(pBroker,pDispUnit,pChapter);
   girder_spacing(pBroker,pDispUnit,pChapter);
   girder_ends(pBroker,pDispUnit,pChapter);
   girder_lengths(pBroker,pDispUnit,pChapter);
...
void girder_points(IBroker* pBroker,IDisplayUnits* pDispUnit,rptChapter* pChapter)
{
   ...
   *pPara << "Girder Points";
   ...
   INIT_UV_PROTOTYPE( rptLengthUnitValue, cogoPoint, pDispUnit->GetAlignmentLengthUnit(), false );
   ...
   for ( SpanIndexType span = 0; span < nSpans; span++ )
   {
      ...
      (*pTable)(2,3)  << COLHDR("Deck Elev", rptLengthUnitTag, pDispUnit->GetAlignmentLengthUnit() );
      (*pTable)(2,4)  << "East" << rptNewLine << "(X)";
      (*pTable)(2,5)  << "North" << rptNewLine << "(Y)";
      (*pTable)(2,6)  << COLHDR("Deck Elev", rptLengthUnitTag, pDispUnit->GetAlignmentLengthUnit() );
      (*pTable)(2,7)  << "East" << rptNewLine << "(X)";
      (*pTable)(2,8)  << "North" << rptNewLine << "(Y)";
      (*pTable)(2,9)  << COLHDR("Deck Elev", rptLengthUnitTag, pDispUnit->GetAlignmentLengthUnit() );
      (*pTable)(2,10) << "East" << rptNewLine << "(X)";
      (*pTable)(2,11) << "North" << rptNewLine << "(Y)";
      (*pTable)(2,12) << COLHDR("Deck Elev", rptLengthUnitTag, pDispUnit->GetAlignmentLengthUnit() );
      (*pTable)(2,13) << "East" << rptNewLine << "(X)";
      (*pTable)(2,14) << "North" << rptNewLine << "(Y)";
      (*pTable)(2,15) << COLHDR("Deck Elev", rptLengthUnitTag, pDispUnit->GetAlignmentLengthUnit() );
      (*pTable)(2,16) << "East" << rptNewLine << "(X)";
      (*pTable)(2,17) << "North" << rptNewLine << "(Y)";
      (*pTable)(2,18) << COLHDR("Deck Elev", rptLengthUnitTag, pDispUnit->GetAlignmentLengthUnit() );
...
void girder_offsets(IBroker* pBroker,IDisplayUnits* pDispUnit,rptChapter* pChapter)
{
   ...
   *pPara << "Girder Offsets";
   ...
   for ( SpanIndexType span = 0; span < nSpans; span++ )
   {
      ...
      (*pTable)(2,1)  << "Station";
      (*pTable)(2,2)  << COLHDR("Offset", rptLengthUnitTag, pDispUnit->GetAlignmentLengthUnit() );
      (*pTable)(2,3)  << COLHDR("Deck Elev", rptLengthUnitTag, pDispUnit->GetAlignmentLengthUnit() );
      (*pTable)(2,4)  << "Station";
      (*pTable)(2,5)  << COLHDR("Offset", rptLengthUnitTag, pDispUnit->GetAlignmentLengthUnit() );
      (*pTable)(2,6)  << COLHDR("Deck Elev", rptLengthUnitTag, pDispUnit->GetAlignmentLengthUnit() );
      (*pTable)(2,7)  << "Station";
      (*pTable)(2,8)  << COLHDR("Offset", rptLengthUnitTag, pDispUnit->GetAlignmentLengthUnit() );
      (*pTable)(2,9)  << COLHDR("Deck Elev", rptLengthUnitTag, pDispUnit->GetAlignmentLengthUnit() );
      (*pTable)(2,10) << "Station";
      (*pTable)(2,11) << COLHDR("Offset", rptLengthUnitTag, pDispUnit->GetAlignmentLengthUnit() );
      (*pTable)(2,12) << COLHDR("Deck Elev", rptLengthUnitTag, pDispUnit->GetAlignmentLengthUnit() );
      (*pTable)(2,13) << "Station";
      (*pTable)(2,14) << COLHDR("Offset", rptLengthUnitTag, pDispUnit->GetAlignmentLengthUnit() );
      (*pTable)(2,15) << COLHDR("Deck Elev", rptLengthUnitTag, pDispUnit->GetAlignmentLengthUnit() );
      (*pTable)(2,16) << "Station";
      (*pTable)(2,17) << COLHDR("Offset", rptLengthUnitTag, pDispUnit->GetAlignmentLengthUnit() );
      (*pTable)(2,18) << COLHDR("Deck Elev", rptLengthUnitTag, pDispUnit->GetAlignmentLengthUnit() );
      ...
      for ( GirderIndexType gdr = 0; gdr < nGdrs; gdr++ )
      {
         ...
         pntPier1->get_X(&x);
         pntPier1->get_Y(&y);
         (*pTable)(row,1) << rptRcStation(station, &pDispUnit->GetStationFormat() );
         ...
         pntEnd1->get_X(&x);
         pntEnd1->get_Y(&y);
         (*pTable)(row,4) << rptRcStation(station, &pDispUnit->GetStationFormat() );
         ...
         pntBrg1->get_X(&x);
         pntBrg1->get_Y(&y);
         (*pTable)(row,7) << rptRcStation(station, &pDispUnit->GetStationFormat() );
         ...
         pntBrg2->get_X(&x);
         pntBrg2->get_Y(&y);
         (*pTable)(row,10) << rptRcStation(station, &pDispUnit->GetStationFormat() );
         ...
         pntEnd2->get_X(&x);
         pntEnd2->get_Y(&y);
         (*pTable)(row,13) << rptRcStation(station, &pDispUnit->GetStationFormat() );
         ...
         pntPier2->get_X(&x);
         pntPier2->get_Y(&y);
         (*pTable)(row,16) << rptRcStation(station, &pDispUnit->GetStationFormat() );
...
void girder_lengths(IBroker* pBroker,IDisplayUnits* pDispUnit,rptChapter* pChapter)
{
   ...
   *pPara << rptNewLine;
   ...
   INIT_UV_PROTOTYPE( rptLengthUnitValue, length,  pDispUnit->GetSpanLengthUnit(), false );
   ...
   for ( SpanIndexType span = 0; span < nSpans; span++ )
   {
      ...
      (*pTable)(0,1) << COLHDR("C-C Pier", rptLengthUnitTag, pDispUnit->GetSpanLengthUnit() );

      pTable->SetRowSpan(0,2,2);
      pTable->SetRowSpan(1,2,-1);
      (*pTable)(0,2) << COLHDR("C-C Bearing" << rptNewLine << Sub2("L","s"), rptLengthUnitTag, pDispUnit->GetSpanLengthUnit() );

      pTable->SetColumnSpan(0,3,2);
      pTable->SetColumnSpan(0,4,-1);
      (*pTable)(0,3) << "Girder Length";
      (*pTable)(1,3) << COLHDR("Horizontal" << rptNewLine << Sub2("L","g"), rptLengthUnitTag, pDispUnit->GetSpanLengthUnit() );
      (*pTable)(1,4) << COLHDR("Along"    << rptNewLine << "Grade", rptLengthUnitTag, pDispUnit->GetSpanLengthUnit() );
...
void girder_spacing(IBroker*pBroker,IDisplayUnits* pDispUnit,rptChapter* pChapter)
{
   ...
   *pPara << "Girder Spacing";
   ...
   INIT_UV_PROTOTYPE( rptLengthUnitValue, spacingValue, pDispUnit->GetXSectionDimUnit(), false );
   ...
   for ( SpanIndexType span = 0; span < nSpans; span++ )
   {
      ...
      (*pTable)(2,1)  << COLHDR(symbol(NORMAL) << " to Alignment",  rptLengthUnitTag,pDispUnit->GetXSectionDimUnit());
      (*pTable)(2,2)  << COLHDR("Along CL Pier",rptLengthUnitTag,pDispUnit->GetXSectionDimUnit());
      (*pTable)(2,3)  << COLHDR(symbol(NORMAL) << " to Alignment",  rptLengthUnitTag,pDispUnit->GetXSectionDimUnit());
      (*pTable)(2,4)  << COLHDR("Along CL Brg",rptLengthUnitTag,pDispUnit->GetXSectionDimUnit());
      pTable->SetRowSpan(2,5,-1);

      (*pTable)(2,6)  << COLHDR(symbol(NORMAL) << " to Alignment",  rptLengthUnitTag,pDispUnit->GetXSectionDimUnit());
      (*pTable)(2,7)  << COLHDR("Along CL Brg",rptLengthUnitTag,pDispUnit->GetXSectionDimUnit());
      (*pTable)(2,8)  << COLHDR(symbol(NORMAL) << " to Alignment",  rptLengthUnitTag,pDispUnit->GetXSectionDimUnit());
      (*pTable)(2,9)  << COLHDR("Along CL Pier",rptLengthUnitTag,pDispUnit->GetXSectionDimUnit());
...
void girder_ends(IBroker* pBroker,IDisplayUnits* pDispUnit,rptChapter* pChapter)
{
   ...
   *pPara << "Girder Ends";
   ...
   for ( SpanIndexType span = 0; span < nSpans; span++ )
   {
      ...
      (*pTable)(2,col2++) << COLHDR(symbol(NORMAL) << " to Pier", rptLengthUnitTag, pDispUnit->GetSpanLengthUnit() );
      (*pTable)(2,col2++) << COLHDR("Along Girder", rptLengthUnitTag, pDispUnit->GetSpanLengthUnit() );
      ...
      pTable->SetRowSpan(2,col2++,-1);
      (*pTable)(1,col1++)<< COLHDR("CL Brg to Girder End" << rptNewLine << "Along Girder", rptLengthUnitTag, pDispUnit->GetSpanLengthUnit() );
