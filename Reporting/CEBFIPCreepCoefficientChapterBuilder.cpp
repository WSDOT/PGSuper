...
/****************************************************************************
CLASS
   CCEBFIPCreepCoefficientChapterBuilder
****************************************************************************/

CCEBFIPCreepCoefficientChapterBuilder::CCEBFIPCreepCoefficientChapterBuilder(bool bSelect) :
CPGSuperChapterBuilder(bSelect)
{
}

LPCTSTR CCEBFIPCreepCoefficientChapterBuilder::GetName() const
{
   return TEXT("Creep Coefficient Details");
}

rptChapter* CCEBFIPCreepCoefficientChapterBuilder::Build(CReportSpecification* pRptSpec,Uint16 level) const
{
   ...
   *pPara << pTable << rptNewLine;
   ...
   (*pTable)(rowIdx,colIdx++) << Sub2(symbol(phi),_T("RH"));
   (*pTable)(rowIdx,colIdx++) << symbol(beta) << _T("(") << RPT_FC << Sub(_T("28")) << _T(")");
...
CChapterBuilder* CCEBFIPCreepCoefficientChapterBuilder::Clone() const
{
   return new CCEBFIPCreepCoefficientChapterBuilder;
}
