                                      ...
                                      IDisplayUnits* pDispUnits) const
{
   ...
   rptRcTable* p_table = CreateUserLoadHeading<rptForceUnitTag,unitmgtForceData>("Shear - User Defined Loads",false,analysisType,pDispUnits,pDispUnits->GetShearUnit());
