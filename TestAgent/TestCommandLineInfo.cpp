...
//======================== LIFECYCLE  =======================================
CTestCommandLineInfo::CTestCommandLineInfo() :
...
CString CTestCommandLineInfo::GetUsageMessage()
{
   return CString(_T(""));
}

CString CTestCommandLineInfo::GetUsageString()
{
...
LPCTSTR CTestCommandLineInfo::GetAppName() const
{
   return _T("PGSuper");
}
