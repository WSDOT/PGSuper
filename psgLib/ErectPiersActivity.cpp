...
HRESULT CSupportActivityBase::Load(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress)
{
   CHRException hr;
...
HRESULT CSupportActivityBase::Save(IStructuredSave* pStrSave,std::shared_ptr<IEAFProgress> pProgress)
{
...
HRESULT CSupportActivityBase::LoadSubclassData(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress)
{
   // does nothing by default
   return S_OK;
}

HRESULT CSupportActivityBase::SaveSubclassData(IStructuredSave* pStrSave,std::shared_ptr<IEAFProgress> pProgress)
{
   // does nothing by default
   return S_OK;
}
...
HRESULT CCastClosureJointActivity::LoadSubclassData(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress)
{
   if ( m_bEnabled )
   {
      CComVariant var;
...
HRESULT CCastClosureJointActivity::SaveSubclassData(IStructuredSave* pStrSave,std::shared_ptr<IEAFProgress> pProgress)
{
   if ( m_bEnabled )
   {
