...
void CSpecMainSheet::ExchangeDesignData(CDataExchange* pDX)
{
   ...
   DDX_Text(pDX, IDC_N2, m_Entry.m_pImpl->m_EndZoneCriteria.HorizTensionTieZoneLengthFactor);
   DDV_GreaterThanZero(pDX, IDC_N2, m_Entry.m_pImpl->m_EndZoneCriteria.HorizTensionTieZoneLengthFactor);
