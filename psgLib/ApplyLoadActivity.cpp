...
HRESULT CApplyLoadActivity::Load(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress)
{
   CHRException hr;
...
HRESULT CApplyLoadActivity::Save(IStructuredSave* pStrSave,std::shared_ptr<IEAFProgress> pProgress)
{
