...
{
public:
   CGirderTypes() = default;
   CGirderTypes(const CGirderTypes& rOther) = default;
   ~CGirderTypes() = default;

   CGirderTypes& operator=(const CGirderTypes& rOther) = default;
...
private:
   ...
   using GirderGroup = std::pair<GirderIndexType,GirderIndexType>; // index of first and last girder in the group
   ...
   friend CSpanData;
   const CSpanData* m_pSpan = nullptr;
};
