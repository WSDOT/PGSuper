...
HRESULT CLoadFactors::Save(IStructuredSave* pStrSave,std::shared_ptr<IEAFProgress> pProgress)
{
...
HRESULT CLoadFactors::Load(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress)
{
   std::array<std::_tstring, 6> strLimitState = { _T("ServiceI"),_T("ServiceIA"),_T("ServiceIII"),_T("StrengthI"),_T("StrengthII"),_T("FatigueI") };
   int nLimitStates = (int)strLimitState.size();
