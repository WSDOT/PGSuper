...
HRESULT CPierData::Load(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress)
{
...
HRESULT CPierData::Load(Float64 version,IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress,const std::_tstring& strUnitName)
{
   ...
   std::array<std::_tstring,2> strConnection;
...
HRESULT CPierData::Save(IStructuredSave* pStrSave,std::shared_ptr<IEAFProgress> pProgress)
{
   ...
   //if (m_DiaphragmLoadType == ConnectionLibraryEntry::DiaphragmLoadType::ApplyAtBearingCenterline)
   //{
   //   pStrSave->put_Property(_T("DiaphragmLoadType"),CComVariant(_T("ApplyAtBearingCenterline")));
   //}
   //else if (m_DiaphragmLoadType == ConnectionLibraryEntry::DiaphragmLoadType::ApplyAtSpecifiedLocation)
   //{
   ...
   //}
   //else if (m_DiaphragmLoadType == ConnectionLibraryEntry::DiaphragmLoadType::DontApply)
   //{
