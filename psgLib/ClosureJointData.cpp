...
HRESULT CClosureJointData::Save(IStructuredSave* pStrSave,std::shared_ptr<IEAFProgress> pProgress)
{
...
HRESULT CClosureJointData::Load(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress)
{
   CHRException hr;
   try
   {
