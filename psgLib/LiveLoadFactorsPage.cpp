...
BOOL CLiveLoadFactorsPage::OnInitDialog()
{
   ...
   if ( pParent->m_RatingDescriptionPage.GetSpecVersion() < WBFL::LRFD::MBEManager::Edition::SecondEditionWith2013Interims )
   {
...
void CLiveLoadFactorsPage::OnLiveLoadFactorTypeChanged()
{
   ...
   case pgsTypes::gllBilinearWithWeight:
      ...
      if ( WBFL::LRFD::MBEManager::Edition::SecondEditionWith2013Interims <= pParent->m_RatingDescriptionPage.GetSpecVersion() )
      {
