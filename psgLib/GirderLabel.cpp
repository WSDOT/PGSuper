...
LPCTSTR GetTempSupportEndDistanceMeasureString(ConnectionLibraryEntry::EndDistanceMeasurementType type, bool bAbbreviation)
{
   switch( type )
   {
   case ConnectionLibraryEntry::EndDistanceMeasurementType::FromBearingAlongGirder:
...
LPCTSTR GetTempSupportBearingOffsetMeasureString(ConnectionLibraryEntry::BearingOffsetMeasurementType type, bool bAbbreviation)
{
   switch( type )
   {
   case ConnectionLibraryEntry::BearingOffsetMeasurementType::AlongGirder:
