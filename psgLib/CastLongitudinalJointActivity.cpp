...
#include "StdAfx.h"
#include <PsgLib\CastLongitudinalJointActivity.h>
...
HRESULT CCastLongitudinalJointActivity::Load(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress)
{
   CHRException hr;
...
HRESULT CCastLongitudinalJointActivity::Save(IStructuredSave* pStrSave,std::shared_ptr<IEAFProgress> pProgress)
{
