...
HRESULT CDebondData::Load(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress)
{
...
HRESULT CDebondData::Save(IStructuredSave* pStrSave,std::shared_ptr<IEAFProgress> pProgress) const
{
