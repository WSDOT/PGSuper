...
HRESULT CGirderGroupData::Load(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress)
{
   CComVariant var;
...
HRESULT CGirderGroupData::Save(IStructuredSave* pStrSave,std::shared_ptr<IEAFProgress> pProgress)
{
