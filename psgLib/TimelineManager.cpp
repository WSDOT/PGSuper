...
HRESULT CTimelineManager::Load(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress)
{
   CHRException hr;
...
HRESULT CTimelineManager::Save(IStructuredSave* pStrSave,std::shared_ptr<IEAFProgress> pProgress)
{
   PGS_ASSERT_VALID;
