...
HRESULT CGirderSpacingData::Load(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress)
{
   USES_CONVERSION;
...
HRESULT CGirderSpacingData::Save(IStructuredSave* pStrSave,std::shared_ptr<IEAFProgress> pProgress)
{
   PGS_ASSERT_VALID;
