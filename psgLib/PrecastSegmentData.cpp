...
HRESULT CPrecastSegmentData::Load(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress)
{
   USES_CONVERSION;
   CComVariant var;
   CHRException hr;
...
Float64 CPrecastSegmentData::GetSegmentHeight(bool bSegmentHeight) const
{
   ...
   auto pGdrEntry = pLibrary->GetGirderEntry(GetGirder()->GetGirderName());
