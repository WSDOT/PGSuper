...
public:
   ...
   HRESULT Load(Float64 version,IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress,const std::_tstring& strUnitName);
...
private:
   ...
   std::array<Float64,2> m_SupportWidth;
