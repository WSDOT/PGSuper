...
//======================== OPERATIONS =======================================
HRESULT CRailingSystem::Load(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress)
{
   USES_CONVERSION;
   ...
   try
   {
      ...
      if ( 3 <= version && version < 5 )
      {
         ...
         else
         {
            ...
            Concrete.Type = (pgsTypes::ConcreteType)WBFL::LRFD::ConcreteUtil::GetTypeFromTypeName(OLE2T(var.bstrVal));
...
HRESULT CRailingSystem::Save(IStructuredSave* pStrSave,std::shared_ptr<IEAFProgress> pProgress)
{
   HRESULT hr = S_OK;
   ...
   //   pStrSave->put_Property(_T("Type"),CComVariant( WBFL::LRFD::ConcreteUtil::GetTypeName((WBFL::Materials::ConcreteType)ConcreteType,false).c_str() ));
