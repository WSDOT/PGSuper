...
HRESULT CCastingRegion::Save(IStructuredSave* pStrSave, std::shared_ptr<IEAFProgress> pProgress)
{
...
HRESULT CCastingRegion::Load(IStructuredLoad* pStrLoad, std::shared_ptr<IEAFProgress> pProgress)
{
   CHRException hr;
...
HRESULT CCastDeckActivity::Load(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress)
{
   CHRException hr;
...
HRESULT CCastDeckActivity::Save(IStructuredSave* pStrSave,std::shared_ptr<IEAFProgress> pProgress)
{
