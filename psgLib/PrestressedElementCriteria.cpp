...
bool PrestressedElementCriteria::Compare(const PrestressedElementCriteria& other, const SpecLibraryEntryImpl& impl, std::vector<std::unique_ptr<DifferenceItem>>& vDifferences, bool bReturnOnFirstDifference) const
{
   bool bSame = true;
   ...
   {
      bSame = false;
      vDifferences.emplace_back(std::make_unique<DifferenceStringItem>(_T("Stress Limits for Temporary Stresses are different"), _T(""), _T("")));
   ...
   {
      bSame = false;
      vDifferences.emplace_back(std::make_unique<DifferenceStringItem>(_T("Cover Limits for Temporary Stresses are different"), _T(""), _T("")));
      if (bReturnOnFirstDifference) return false;
   }
   ...
   {
      bSame = false;
      vDifferences.emplace_back(std::make_unique<DifferenceStringItem>(_T("Stress Limits at Service Limit State are different"), _T(""), _T("")));
      if (bReturnOnFirstDifference) return false;
   }
   ...
   {
      bSame = false;
      vDifferences.emplace_back(std::make_unique<DifferenceStringItem>(_T("Allowable Concrete Stress at Fatigue Limit State are different"), _T(""), _T("")));
      if (bReturnOnFirstDifference) return false;
   }
   ...
   {
      bSame = false;
      vDifferences.emplace_back(std::make_unique<DifferenceStringItem>(_T("Stress Limits for Temporary Loading Conditions are different"), _T(""), _T("")));
      if (bReturnOnFirstDifference) return false;
   }
