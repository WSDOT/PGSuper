...
HRESULT CSegmentDuctData::Load(IStructuredLoad* pStrLoad, std::shared_ptr<IEAFProgress> pProgress)
{
   USES_CONVERSION;
   CHRException hr;
   CComVariant var;
...
HRESULT CSegmentDuctData::Save(IStructuredSave* pStrSave, std::shared_ptr<IEAFProgress> pProgress)
{
...
HRESULT CSegmentPTData::Load(IStructuredLoad* pStrLoad, std::shared_ptr<IEAFProgress> pProgress)
{
...
HRESULT CSegmentPTData::Save(IStructuredSave* pStrSave, std::shared_ptr<IEAFProgress> pProgress)
{
