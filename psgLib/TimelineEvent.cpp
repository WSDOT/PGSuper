...
HRESULT CTimelineEvent::Load(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress)
{
   USES_CONVERSION;
   CHRException hr;
...
HRESULT CTimelineEvent::Save(IStructuredSave* pStrSave,std::shared_ptr<IEAFProgress> pProgress)
{
