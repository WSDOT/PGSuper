...
HRESULT CBridgeDescription::Load(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress)
{
...
HRESULT CBridgeDescription::Load(Float64 version,IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress)
{
