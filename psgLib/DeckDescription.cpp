...
HRESULT CDeckDescription::Load(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress,pgsTypes::SlabOffsetType* pSlabOffsetType,Float64* pSlabOffset)
{
   USES_CONVERSION;
...
HRESULT CDeckDescription::Save(IStructuredSave* pStrSave,std::shared_ptr<IEAFProgress> pProgress)
{
   HRESULT hr = S_OK;
