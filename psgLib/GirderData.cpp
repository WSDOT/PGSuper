...
HRESULT CGirderData::Load(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress, 
...
HRESULT CGirderData::Save(IStructuredSave* pStrSave,std::shared_ptr<IEAFProgress> pProgress)
{
   HRESULT hr = S_OK;
