...
// Construction
public:
   CLibraryEntryConflict(const std::_tstring& strServer, const std::_tstring& strConfiguration, const std::_tstring& entryName, const std::_tstring& libName, const std::vector<std::_tstring>& keylists, bool isImported, const std::vector<std::unique_ptr<DifferenceItem>>& vDifferences,bool bMustRename,CWnd* pParent = NULL);
...
public:
   ...
   const std::vector<std::unique_ptr<DifferenceItem>>& m_vDifferences;
