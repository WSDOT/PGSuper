...
HRESULT CStrandRow::Save(IStructuredSave* pStrSave,std::shared_ptr<IEAFProgress> pProgress)
{
...
HRESULT CStrandRow::Load(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress)
{
   CHRException hr;
   try
   {
...
HRESULT CStrandData::Load(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress,Float64* pVersion)
{
   USES_CONVERSION;
...
HRESULT CStrandData::Save(IStructuredSave* pStrSave,std::shared_ptr<IEAFProgress> pProgress)
{
   HRESULT hr = S_OK;
