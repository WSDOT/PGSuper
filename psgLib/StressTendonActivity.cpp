...
#include "StdAfx.h"
#include <PsgLib\StressTendonActivity.h>
...
HRESULT CStressTendonActivity::Load(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress)
{
   CHRException hr;
...
HRESULT CStressTendonActivity::Save(IStructuredSave* pStrSave,std::shared_ptr<IEAFProgress> pProgress)
{
