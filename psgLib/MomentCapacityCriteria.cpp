...
bool MomentCapacityCriteria::Compare(const MomentCapacityCriteria& other, const SpecLibraryEntryImpl& impl, std::vector<std::unique_ptr<DifferenceItem>>& vDifferences, bool bReturnOnFirstDifference) const
{
   bool bSame = true;
   ...
   {
      bSame = false;
      vDifferences.emplace_back(std::make_unique<DifferenceStringItem>(_T("Moment Capacity parameters are different"), _T(""), _T("")));
   ...
   {
      bSame = false;
      vDifferences.emplace_back(std::make_unique<DifferenceStringItem>(_T("Moment Resistance Factors are different"), _T(""), _T("")));
      if (bReturnOnFirstDifference) return false;
   }
   ...
   {
      bSame = false;
      vDifferences.emplace_back(std::make_unique<DifferenceStringItem>(_T("Negative Moment Capacity parameters are different"), _T(""), _T("")));
      if (bReturnOnFirstDifference) return false;
   }
