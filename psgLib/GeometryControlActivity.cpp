...
HRESULT CGeometryControlActivity::Load(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress)
{
   CHRException hr;
...
HRESULT CGeometryControlActivity::Save(IStructuredSave* pStrSave,std::shared_ptr<IEAFProgress> pProgress)
{
