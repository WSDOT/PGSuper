...
HRESULT CTemporarySupportActivityBase::Load(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress)
{
   CHRException hr;
...
HRESULT CTemporarySupportActivityBase::Save(IStructuredSave* pStrSave,std::shared_ptr<IEAFProgress> pProgress)
{
