...
{
    //int list[] = { IDC_BEARING_METHOD_A, IDC_SHEAR_MOD_MIN_LIMIT, IDC_SHEAR_MOD_MAX_LIMIT, IDC_REQ_INT_LAYER_THICK_CHECK,
    //    IDC_REQ_INT_LAYER_THICK, IDC_MIN_BEARING_HEIGHT_CHECK, IDC_MIN_BEARING_HEIGHT, IDC_MIN_BEARING_GIRDER_EDGE_CHECK,
    //    IDC_MIN_BEARING_GIRDER_EDGE, IDC_MIN_BEARING_GIRDER_EDGE_CHECK, IDC_MIN_BEARING_GIRDER_EDGE, IDC_MAX_BEARING_GIRDER_EDGE_CHECK,
    //    IDC_MAX_BEARING_GIRDER_EDGE,-1 };
    //CheckDesignCtrl(IDC_CHECK_BEARING, IDC_DESIGN_BEARING, list, this);
}
