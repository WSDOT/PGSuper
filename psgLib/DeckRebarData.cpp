...
CDeckRebarData::CDeckRebarData()
{
   ...
   // default values are for LRFD empirical deck design
...
HRESULT CDeckRebarData::Save(IStructuredSave* pStrSave,std::shared_ptr<IEAFProgress> pProgress)
{
   HRESULT hr = S_OK;
...
HRESULT CDeckRebarData::Load(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress)
{
   USES_CONVERSION;
   HRESULT hr = S_OK;
