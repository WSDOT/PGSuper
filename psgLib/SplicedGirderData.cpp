...
HRESULT CSplicedGirderData::Save(IStructuredSave* pStrSave,std::shared_ptr<IEAFProgress> pProgress)
{
...
HRESULT CSplicedGirderData::Load(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress)
{
   USES_CONVERSION;
