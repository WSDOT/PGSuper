...
HRESULT CConcreteMaterial::Save(IStructuredSave* pStrSave,std::shared_ptr<IEAFProgress> pProgress)
{
...
HRESULT CConcreteMaterial::Load(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress)
{
   CComVariant var;
   USES_CONVERSION;
