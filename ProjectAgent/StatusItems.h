...
class pgsRebarStrengthStatusItem : public pgsSpanGirderRelatedStatusItem
{
public:
   enum Type { Longitudinal, Transverse, Deck };
   pgsRebarStrengthStatusItem(SpanIndexType span,GirderIndexType gdr,Type type,StatusGroupIDType statusGroupID,StatusCallbackIDType callbackID,LPCTSTR strDescription);
