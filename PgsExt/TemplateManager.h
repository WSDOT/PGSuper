...
{
public:
	CTemplateManager(LPCTSTR strExt,CHAR chSep); // chSep is the folder separator chacter
...
class CFileTemplateManager : public CTemplateManager
{
public:
...
class CFTPTemplateManager : public CTemplateManager
{
public:
