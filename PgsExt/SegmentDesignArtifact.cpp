...
void pgsSegmentDesignArtifact::SetConcreteStrength(Float64 fc)
{
   ...
   if (!m_IsUserEc)
   {
      ...
      Float64 Ec = WBFL::LRFD::ConcreteUtil::ModE(m_Concrete.GetType(),fc,density,false);
      m_Concrete.SetE(Ec);
   }
}
...
GDRCONFIG pgsSegmentDesignArtifact::GetSegmentConfiguration() const
{
   ...
   {
      config.Eci = WBFL::LRFD::ConcreteUtil::ModE( (WBFL::Materials::ConcreteType)config.ConcType, config.fci, m_Concrete.GetDensity(), false);
   }
   ...
   {
      config.Ec = WBFL::LRFD::ConcreteUtil::ModE((WBFL::Materials::ConcreteType)config.ConcType, config.fc, m_Concrete.GetDensity(), false);
   }
...
void pgsSegmentDesignArtifact::ModSegmentDataForFlexureDesign(IBroker* pBroker, CPrecastSegmentData* pSegmentData) const
{
   ...
   {
      pSegmentData->Material.Concrete.Eci = WBFL::LRFD::ConcreteUtil::ModE( (WBFL::Materials::ConcreteType)pSegmentData->Material.Concrete.Type,pSegmentData->Material.Concrete.Fci, 
   ...
   {
      pSegmentData->Material.Concrete.Ec = WBFL::LRFD::ConcreteUtil::ModE((WBFL::Materials::ConcreteType)pSegmentData->Material.Concrete.Type, pSegmentData->Material.Concrete.Fc,
                                                            pSegmentData->Material.Concrete.StrengthDensity, 
                                                            false );// ignore LRFD range checks 
