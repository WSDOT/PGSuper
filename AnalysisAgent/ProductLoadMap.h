...
public:
   ...
   static std::vector<pgsTypes::ProductForceType> GetProductForces(std::shared_ptr<WBFL::EAF::Broker> pBroker,LoadingCombinationType combo);

   static std::vector<pgsTypes::ProductForceType> GetProductForces(std::shared_ptr<WBFL::EAF::Broker> pBroker,const CGirderKey& girderKey);
