...
void CTxDotDoubleTFactory::CreateSegment(IBroker* pBroker,StatusGroupIDType statusGroupID,const CSegmentKey& segmentKey,IStages* pStages,ISuperstructureMember* ssmbr)
{
...
Float64 CTxDotDoubleTFactory::GetVolume(IBroker* pBroker,const CSegmentKey& segmentKey)
{
...
Float64 CTxDotDoubleTFactory::GetSurfaceArea(IBroker* pBroker,const CSegmentKey& segmentKey,bool bReduceForPoorlyVentilatedVoids)
{
