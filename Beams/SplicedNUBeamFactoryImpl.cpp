...
void CSplicedNUBeamFactory::CreateSegment(IBroker* pBroker,StatusGroupIDType statusGroupID,const CSegmentKey& segmentKey,IStages* pStages,ISuperstructureMember* ssmbr)
{
...
void CSplicedNUBeamFactory::CreateStrandMover(const IBeamFactory::Dimensions& dimensions, 
...
Float64 CSplicedNUBeamFactory::GetVolume(IBroker* pBroker,const CSegmentKey& segmentKey)
{
...
Float64 CSplicedNUBeamFactory::GetSurfaceArea(IBroker* pBroker,const CSegmentKey& segmentKey,bool bReduceForPoorlyVentilatedVoids)
{
