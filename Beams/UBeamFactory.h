...
namespace PGS
{
   namespace Beams
   {
      class UBeamFactory : public BeamFactory, public BeamFactorySingleton<UBeamFactory>
      {
      public:
         static std::shared_ptr<UBeamFactory> CreateInstance() { return std::shared_ptr<UBeamFactory>(new UBeamFactory()); }
