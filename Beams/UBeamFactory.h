...
namespace PGS
{
   namespace Beams
   {
      class CUBeamFactory : public BeamFactory, public BeamFactorySingleton<CUBeamFactory>
      {
      public:
         static std::shared_ptr<CUBeamFactory> CreateInstance() { return std::shared_ptr<CUBeamFactory>(new CUBeamFactory()); }
      ...
      private:
         void DimensionAndPositionBeam(const BeamFactory::Dimensions& dimensions, IUBeam* pBeam) const;
      };
   };
};
