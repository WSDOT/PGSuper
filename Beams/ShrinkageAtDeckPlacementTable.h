...
{
public:
	static CShrinkageAtDeckPlacementTable* PrepareTable(rptChapter* pChapter,IBroker* pBroker,SpanIndexType span,GirderIndexType gdr,LOSSDETAILS& details,IDisplayUnits* pDisplayUnits,Uint16 level);
...
private:
   CShrinkageAtDeckPlacementTable(ColumnIndexType NumColumns, IDisplayUnits* pDisplayUnits);
