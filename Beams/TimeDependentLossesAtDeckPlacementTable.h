...
{
public:
	static CTimeDependentLossesAtDeckPlacementTable* PrepareTable(rptChapter* pChapter,IBroker* pBroker,SpanIndexType span,GirderIndexType gdr,IDisplayUnits* pDispUnit,Uint16 level);
...
private:
   CTimeDependentLossesAtDeckPlacementTable(ColumnIndexType NumColumns, IDisplayUnits* pDispUnit);
