...
{
public:
	static CCreepAtDeckPlacementTable* PrepareTable(rptChapter* pChapter,IBroker* pBroker,SpanIndexType span,GirderIndexType gdr,IDisplayUnits* pDisplayUnits,Uint16 level);
...
private:
   CCreepAtDeckPlacementTable(ColumnIndexType numColumns, IDisplayUnits* pDisplayUnits);
