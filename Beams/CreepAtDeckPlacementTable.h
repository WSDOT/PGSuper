...
{
public:
	static CCreepAtDeckPlacementTable* PrepareTable(rptChapter* pChapter,IBroker* pBroker,SpanIndexType span,GirderIndexType gdr,IDisplayUnits* pDispUnit,Uint16 level);
...
private:
   CCreepAtDeckPlacementTable(ColumnIndexType numColumns, IDisplayUnits* pDispUnit);
