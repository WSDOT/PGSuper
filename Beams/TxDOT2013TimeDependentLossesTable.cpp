...
CTxDOT2013TimeDependentLossesTable* CTxDOT2013TimeDependentLossesTable::PrepareTable(rptChapter* pChapter,IBroker* pBroker,SpanIndexType span,GirderIndexType gdr,IEAFDisplayUnits* pDisplayUnits,Uint16 level)
{
...
void CTxDOT2013TimeDependentLossesTable::AddRow(rptChapter* pChapter,IBroker* pBroker,const pgsPointOfInterest& poi,RowIndexType row,LOSSDETAILS& details,IEAFDisplayUnits* pDisplayUnits,Uint16 level)
{
   ...
   (*this)(row,5) << stress.SetValue(details.pLosses->TimeDependentLosses());
}
