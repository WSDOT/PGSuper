...
{
public:
	static CFrictionLossTable* PrepareTable(rptChapter* pChapter,IBroker* pBroker,SpanIndexType span,GirderIndexType gdr,LOSSDETAILS& details,IDisplayUnits* pDispUnit,Uint16 level);
...
private:
   CFrictionLossTable(ColumnIndexType NumColumns, IDisplayUnits* pDispUnit);
