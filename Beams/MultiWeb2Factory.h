...
namespace PGS
{
   namespace Beams
   {
      class CMultiWeb2Factory : public BeamFactory, public BeamFactorySingleton<CMultiWeb2Factory>
      {
      public:
         static std::shared_ptr<CMultiWeb2Factory> CreateInstance() { return std::shared_ptr<CMultiWeb2Factory>(new CMultiWeb2Factory()); }
      ...
      private:
         ...
         void DimensionAndPositionBeam(std::shared_ptr<WBFL::EAF::Broker> pBroker, const BeamFactory::Dimensions& dimensions, IMultiWeb2* pBeam) const;
      };
   };
};
