...
namespace PGS
{
   namespace Beams
   {
      class MultiWeb2Factory : public BeamFactory, public BeamFactorySingleton<MultiWeb2Factory>
      {
      public:
         static std::shared_ptr<MultiWeb2Factory> CreateInstance() { return std::shared_ptr<MultiWeb2Factory>(new MultiWeb2Factory()); }
