...
class CMultiWeb2Factory : public IBeamFactory
{
public:
   CMultiWeb2Factory();
...
private:
   ...
   void DimensionAndPositionBeam(std::shared_ptr<WBFL::EAF::Broker> pBroker, const IBeamFactory::Dimensions& dimensions, IMultiWeb2* pBeam) const;
};
