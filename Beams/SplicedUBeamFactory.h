...
public:
   ...
   virtual void CreateGirderProfile(IBroker* pBroker,StatusGroupIDType statusGroupID,const CSegmentKey& segmentKey,const IBeamFactory::Dimensions& dimensions,IShape** ppShape) const override;
...
// ISplicedBeamFactory
   virtual bool SupportsVariableDepthSection() const override;
   virtual LPCTSTR GetVariableDepthDimension() const override;
   virtual std::vector<pgsTypes::SegmentVariationType> GetSupportedSegmentVariations(bool bIsVariableDepthSection) const override;
   virtual bool CanBottomFlangeDepthVary() const override;
   virtual LPCTSTR GetBottomFlangeDepthDimension() const override;
   virtual bool SupportsEndBlocks() const override;
