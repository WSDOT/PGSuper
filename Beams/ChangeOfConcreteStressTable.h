...
{
public:
	static CChangeOfConcreteStressTable* PrepareTable(rptChapter* pChapter,IBroker* pBroker,SpanIndexType span,GirderIndexType gdr,IDisplayUnits* pDisplayUnits,Uint16 level);
...
private:
   CChangeOfConcreteStressTable(ColumnIndexType NumColumns, IDisplayUnits* pDisplayUnits);
