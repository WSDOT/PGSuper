...
{
public:
	static CRelaxationAtDeckPlacementTable* PrepareTable(rptChapter* pChapter,IBroker* pBroker,SpanIndexType span,GirderIndexType gdr,LOSSDETAILS& details,IDisplayUnits* pDispUnit,Uint16 level);
...
private:
   CRelaxationAtDeckPlacementTable(ColumnIndexType NumColumns, IDisplayUnits* pDispUnit);
