...
namespace PGS
{
   namespace Beams
   {
      class CTaperedIBeamFactory : public BeamFactory, public BeamFactorySingleton<CTaperedIBeamFactory>
      {
      public:
         static std::shared_ptr<CTaperedIBeamFactory> CreateInstance() { return std::shared_ptr<CTaperedIBeamFactory>(new CTaperedIBeamFactory()); }
      ...
      private:
         ...
         void CreateGirderSection(std::shared_ptr<WBFL::EAF::Broker> pBroker,StatusGroupIDType statusGroupID,pgsTypes::MemberEndType end,const BeamFactory::Dimensions& dimensions,IGirderSection** ppSection) const;
