...
namespace PGS
{
   namespace Beams
   {
      class TaperedIBeamFactory : public BeamFactory, public BeamFactorySingleton<TaperedIBeamFactory>
      {
      public:
         static std::shared_ptr<TaperedIBeamFactory> CreateInstance() { return std::shared_ptr<TaperedIBeamFactory>(new TaperedIBeamFactory()); }
