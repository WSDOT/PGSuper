...
{
public:
	static CPostTensionTimeDependentLossesAtShippingTable* PrepareTable(rptChapter* pChapter,IBroker* pBroker,SpanIndexType span,GirderIndexType gdr,IDisplayUnits* pDispUnit,Uint16 level);
...
private:
   CPostTensionTimeDependentLossesAtShippingTable(ColumnIndexType NumColumns, IDisplayUnits* pDispUnit);
