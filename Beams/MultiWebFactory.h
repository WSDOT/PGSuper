...
namespace PGS
{
   namespace Beams
   {
      class CMultiWebFactory : public BeamFactory, public BeamFactorySingleton<CMultiWebFactory>
      {
      public:
         static std::shared_ptr<CMultiWebFactory> CreateInstance() { return std::shared_ptr<CMultiWebFactory>(new CMultiWebFactory()); }
      ...
      private:
         ...
         void DimensionAndPositionBeam(std::shared_ptr<WBFL::EAF::Broker> pBroker, const BeamFactory::Dimensions& dimensions, IMultiWeb* pBeam) const;
      };
   };
};
