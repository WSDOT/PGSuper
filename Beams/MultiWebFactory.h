...
namespace PGS
{
   namespace Beams
   {
      class MultiWebFactory : public BeamFactory, public BeamFactorySingleton<MultiWebFactory>
      {
      public:
         static std::shared_ptr<MultiWebFactory> CreateInstance() { return std::shared_ptr<MultiWebFactory>(new MultiWebFactory()); }
