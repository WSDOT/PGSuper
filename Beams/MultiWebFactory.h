...
// MultiWebFactory.h : Declaration of the CMultiWebFactory

#ifndef __MULTIWEBFACTORY_H_
#define __MULTIWEBFACTORY_H_
...
/////////////////////////////////////////////////////////////////////////////
// CMultiWebFactory
class ATL_NO_VTABLE CMultiWebFactory : 
   public CComObjectRootEx<CComSingleThreadModel>,
   public CComCoClass<CMultiWebFactory, &CLSID_MultiWebFactory>,
   public IBeamFactory
{
public:
	CMultiWebFactory()
...
DECLARE_REGISTRY_RESOURCEID(IDR_MULTIWEBFACTORY)
DECLARE_CLASSFACTORY_SINGLETON(CMultiWebFactory)

BEGIN_COM_MAP(CMultiWebFactory)
   COM_INTERFACE_ENTRY(IBeamFactory)
END_COM_MAP()

public:
   // IBeamFactory
   void CreateGirderSection(std::shared_ptr<WBFL::EAF::Broker> pBroker,StatusGroupIDType statusGroupID,const IBeamFactory::Dimensions& dimensions,Float64 overallHeight,Float64 bottomFlangeHeight,IGirderSection** ppSection) const override;
   ...
   void GetAllowableTopWidthRange(pgsTypes::TopWidthType topWidthType, const IBeamFactory::Dimensions& dimensions, Float64* pWleftMin, Float64* pWleftMax, Float64* pWrightMin, Float64* pWrightMax) const override { *pWleftMin = 0; *pWleftMax = 0; *pWrightMin = 0; *pWrightMax = 0; }
...
private:
   ...
   void DimensionAndPositionBeam(std::shared_ptr<WBFL::EAF::Broker> pBroker, const IBeamFactory::Dimensions& dimensions, IMultiWeb* pBeam) const;
};
