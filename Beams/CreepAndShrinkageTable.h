...
{
public:
	static CCreepAndShrinkageTable* PrepareTable(rptChapter* pChapter,IBroker* pBroker,SpanIndexType span,GirderIndexType gdr,IDisplayUnits* pDispUnit,Uint16 level);
...
private:
   CCreepAndShrinkageTable(ColumnIndexType NumColumns, IDisplayUnits* pDispUnit);
