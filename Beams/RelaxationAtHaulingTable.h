...
{
public:
   static CRelaxationAtHaulingTable* PrepareTable(rptChapter* pChapter,IBroker* pBroker,SpanIndexType span,GirderIndexType gdr,bool bTemporaryStrands,LOSSDETAILS& details,IDisplayUnits* pDispUnit,Uint16 level);
...
private:
   CRelaxationAtHaulingTable(ColumnIndexType NumColumns, IDisplayUnits* pDispUnit);
