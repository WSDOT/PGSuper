...
{
public:
	static CRelaxationAfterTransferTable* PrepareTable(rptChapter* pChapter,IBroker* pBroker,SpanIndexType span,GirderIndexType gdr,IDisplayUnits* pDispUnit,Uint16 level);
...
private:
   CRelaxationAfterTransferTable(ColumnIndexType NumColumns, IDisplayUnits* pDispUnit);
