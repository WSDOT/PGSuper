...
namespace PGS
{
   namespace Beams
   {
      class CVoidedSlabFactory : public BeamFactory, public BeamFactorySingleton<CVoidedSlabFactory>
      {
      public:
         static std::shared_ptr<CVoidedSlabFactory> CreateInstance() { return std::shared_ptr<CVoidedSlabFactory>(new CVoidedSlabFactory()); }
      ...
      private:
         ...
         void DimensionAndPositionBeam(const BeamFactory::Dimensions& dimensions, IVoidedSlab* pBeam) const;
      };
   };
};
