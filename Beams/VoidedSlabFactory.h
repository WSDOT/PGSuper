...
namespace PGS
{
   namespace Beams
   {
      class VoidedSlabFactory : public BeamFactory, public BeamFactorySingleton<VoidedSlabFactory>
      {
      public:
         static std::shared_ptr<VoidedSlabFactory> CreateInstance() { return std::shared_ptr<VoidedSlabFactory>(new VoidedSlabFactory()); }
