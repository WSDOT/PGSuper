...
namespace PGS
{
   namespace Beams
   {
      class CUBeam2Factory : public BeamFactory, public BeamFactorySingleton<CUBeam2Factory>
      {
      public:
         static std::shared_ptr<CUBeam2Factory> CreateInstance() { return std::shared_ptr<CUBeam2Factory>(new CUBeam2Factory()); }
      ...
      private:
         void DimensionAndPositionBeam(const BeamFactory::Dimensions& dimensions, IUBeam2* pBeam) const;
      };
   };
};
