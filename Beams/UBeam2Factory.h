...
namespace PGS
{
   namespace Beams
   {
      class UBeam2Factory : public BeamFactory, public BeamFactorySingleton<UBeam2Factory>
      {
      public:
         static std::shared_ptr<UBeam2Factory> CreateInstance() { return std::shared_ptr<UBeam2Factory>(new UBeam2Factory()); }
