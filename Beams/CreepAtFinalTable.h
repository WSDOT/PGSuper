...
{
public:
	static CCreepAtFinalTable* PrepareTable(rptChapter* pChapter,IBroker* pBroker,SpanIndexType span,GirderIndexType gdr,LOSSDETAILS& details,IDisplayUnits* pDisplayUnits,Uint16 level);
...
private:
   CCreepAtFinalTable(ColumnIndexType NumColumns, IDisplayUnits* pDisplayUnits);
