...
{
public:
	static CEffectOfPostTensionedTemporaryStrandsTable* PrepareTable(rptChapter* pChapter,IBroker* pBroker,SpanIndexType span,GirderIndexType gdr,IDisplayUnits* pDisplayUnits,Uint16 level);
...
private:
   CEffectOfPostTensionedTemporaryStrandsTable(ColumnIndexType NumColumns, IDisplayUnits* pDisplayUnits);
