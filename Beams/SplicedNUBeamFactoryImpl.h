...
namespace PGS
{
   namespace Beams
   {
      class SplicedNUBeamFactory : public SplicedBeamFactory, public BeamFactorySingleton<SplicedNUBeamFactory>
      {
      public:
         static std::shared_ptr<SplicedNUBeamFactory> CreateInstance() { return std::shared_ptr<SplicedNUBeamFactory>(new SplicedNUBeamFactory()); }
