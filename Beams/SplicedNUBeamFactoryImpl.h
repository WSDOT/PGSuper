...
class CSplicedNUBeamFactory : public ISplicedBeamFactory
{
public:
...
private:
   ...
   void DimensionAndPositionBeam(const IBeamFactory::Dimensions& dimensions, Float64 Hg, Float64 Hbf, INUBeam* pBeam) const;
};
