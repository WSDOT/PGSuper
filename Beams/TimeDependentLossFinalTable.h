...
{
public:
	static CTimeDependentLossFinalTable* PrepareTable(rptChapter* pChapter,IBroker* pBroker,SpanIndexType span,GirderIndexType gdr,IDisplayUnits* pDisplayUnits,Uint16 level);
...
private:
   CTimeDependentLossFinalTable(ColumnIndexType NumColumns, IDisplayUnits* pDisplayUnits);
