...
{
public:
	static CElasticGainDueToDeckPlacementTable* PrepareTable(rptChapter* pChapter,IBroker* pBroker,SpanIndexType span,GirderIndexType gdr,IDisplayUnits* pDispUnit,Uint16 level);
...
private:
   CElasticGainDueToDeckPlacementTable(ColumnIndexType NumColumns, IDisplayUnits* pDispUnit);
