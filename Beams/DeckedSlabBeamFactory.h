...
namespace PGS
{
   namespace Beams
   {
      class CDeckedSlabBeamFactory : public BeamFactory, public BeamFactorySingleton<CDeckedSlabBeamFactory>
      {
      public:
         static std::shared_ptr<CDeckedSlabBeamFactory> CreateInstance() { return std::shared_ptr<CDeckedSlabBeamFactory>(new CDeckedSlabBeamFactory()); }
