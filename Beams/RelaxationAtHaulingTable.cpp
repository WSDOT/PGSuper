...
CRelaxationAtHaulingTable::CRelaxationAtHaulingTable(ColumnIndexType NumColumns, std::shared_ptr<IEAFDisplayUnits> pDisplayUnits) :
...
CRelaxationAtHaulingTable* CRelaxationAtHaulingTable::PrepareTable(rptChapter* pChapter,std::shared_ptr<WBFL::EAF::Broker> pBroker,const CSegmentKey& segmentKey,bool bTemporaryStrands,const LOSSDETAILS* pDetails,std::shared_ptr<IEAFDisplayUnits> pDisplayUnits,Uint16 level)
{
  ...
  // Typecast to our known type (eating own doggy food)
   ...
   if ( ptl->GetRelaxationLossMethod() == WBFL::LRFD::RefinedLosses2005::RelaxationLossMethod::Simplified )
   {
      numColumns++;
   }
   else if (ptl->GetRelaxationLossMethod() == WBFL::LRFD::RefinedLosses2005::RelaxationLossMethod::Refined )
   {
      numColumns += 4;
   }
   ...
   *pChapter << pParagraph;
   *pParagraph << _T("[") << WBFL::LRFD::LrfdCw8th(_T("5.9.5.4.2c"),_T("5.9.3.4.2c")) << _T("] Relaxation of Prestressing Strands : ") << symbol(DELTA) << RPT_STRESS(_T("pR1H")) << rptNewLine;
   ...
   *pChapter << pParagraph;
   ...
   {
   case WBFL::LRFD::RefinedLosses2005::RelaxationLossMethod::Simplified:
   ...
   case WBFL::LRFD::RefinedLosses2005::RelaxationLossMethod::Refined:
   ...
   case WBFL::LRFD::RefinedLosses2005::RelaxationLossMethod::LumpSum:
      break;
   ...
   *pParagraph << table << rptNewLine;
   ...
   if ( bTemporaryStrands )
   {
      ...
      else if ( ptl->GetRelaxationLossMethod() == WBFL::LRFD::RefinedLosses2005::RelaxationLossMethod::LumpSum )
      {
         (*table)(0,col) << _T("Permanent Strands");
      }
      else
...
void CRelaxationAtHaulingTable::AddRow(rptChapter* pChapter,std::shared_ptr<WBFL::EAF::Broker> pBroker,const pgsPointOfInterest& poi,RowIndexType row,const LOSSDETAILS* pDetails,std::shared_ptr<IEAFDisplayUnits> pDisplayUnits,Uint16 level)
{
