...
class CTxDotDoubleTFactory : public IBeamFactory
{
public:
...
private:
   ...
   void DimensionAndPositionBeam(const CPrecastSegmentData* pSegment,const IBeamFactory::Dimensions& dimensions, IMultiWeb2* pBeam) const;
};
