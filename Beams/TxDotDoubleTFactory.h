...
namespace PGS
{
   namespace Beams
   {
      class TxDotDoubleTFactory : public BeamFactory, public BeamFactorySingleton<TxDotDoubleTFactory>
      {
      public:
         static std::shared_ptr<TxDotDoubleTFactory> CreateInstance() { return std::shared_ptr<TxDotDoubleTFactory>(new TxDotDoubleTFactory()); }
