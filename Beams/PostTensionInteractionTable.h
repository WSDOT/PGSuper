...
{
public:
	static CPostTensionInteractionTable* PrepareTable(rptChapter* pChapter,IBroker* pBroker,SpanIndexType span,GirderIndexType gdr,IDisplayUnits* pDispUnit,Uint16 level);
...
private:
   CPostTensionInteractionTable(ColumnIndexType NumColumns, IDisplayUnits* pDispUnit);
