...
/////////////////////////////////////////////////////////////////////////////
// CPostTensionInteractionTable
class CPostTensionInteractionTable : public rptRcTable
{
public:
	static CPostTensionInteractionTable* PrepareTable(rptChapter* pChapter,std::shared_ptr<WBFL::EAF::Broker> pBroker,const CSegmentKey& segmentKey,std::shared_ptr<IEAFDisplayUnits> pDisplayUnits,Uint16 level);
...
private:
   CPostTensionInteractionTable(ColumnIndexType NumColumns, std::shared_ptr<IEAFDisplayUnits> pDisplayUnits);
