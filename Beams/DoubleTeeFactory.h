...
namespace PGS
{
   namespace Beams
   {
      class DoubleTeeFactory : public BeamFactory, public BeamFactorySingleton<DoubleTeeFactory>
      {
      public:
         static std::shared_ptr<DoubleTeeFactory> CreateInstance() { return std::shared_ptr<DoubleTeeFactory>(new DoubleTeeFactory()); }
