...
namespace PGS
{
   namespace Beams
   {
      class CDoubleTeeFactory : public BeamFactory, public BeamFactorySingleton<CDoubleTeeFactory>
      {
      public:
         static std::shared_ptr<CDoubleTeeFactory> CreateInstance() { return std::shared_ptr<CDoubleTeeFactory>(new CDoubleTeeFactory()); }
