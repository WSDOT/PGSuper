...
{
public:
	static CTotalPrestressLossTable* PrepareTable(rptChapter* pChapter,IBroker* pBroker,SpanIndexType span,GirderIndexType gdr,IDisplayUnits* pDispUnit,Uint16 level);
...
private:
   CTotalPrestressLossTable(ColumnIndexType NumColumns, IDisplayUnits* pDispUnit);
