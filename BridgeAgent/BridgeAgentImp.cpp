...
IntervalIndexType CBridgeAgentImp::GetStressFirstTendonInterval(const CGirderKey& girderKey)
{
   VALIDATE(BRIDGE);
...
IntervalIndexType CBridgeAgentImp::GetStressLastTendonInterval(const CGirderKey& girderKey)
{
   VALIDATE(BRIDGE);
