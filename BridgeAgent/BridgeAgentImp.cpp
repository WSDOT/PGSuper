...
{
   // The only method that calls this is CBridgeSectionView::BuildOverlayDisplayObjects()
   // and what that method really needs is a model of the top surface of the deck.
#pragma Reminder("FIX")
   //ATLASSERT(false);
   return 0.0;
