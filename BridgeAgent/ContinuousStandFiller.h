...
public:
   ...
   virtual HRESULT IsValidNumStraightStrands(IPrecastGirder* girder, StrandIndexType nStrands,VARIANT_BOOL* bIsValid) const = 0;
   ...
   virtual HRESULT IsValidNumHarpedStrands(IPrecastGirder* girder, StrandIndexType nStrands,VARIANT_BOOL* bIsValid) const = 0;
   ...
   virtual HRESULT IsValidNumTemporaryStrands(IPrecastGirder* girder, StrandIndexType nStrands,VARIANT_BOOL* bIsValid) const = 0;
   ...
   virtual HRESULT ComputeStraightStrandFill(IPrecastGirder* girder, StrandIndexType nStrands, IIndexArray** strandFill) const = 0;
   ...
   virtual HRESULT ComputeHarpedStrandFill(IPrecastGirder* girder, StrandIndexType nStrands, IIndexArray** strandFill) const = 0;
   ...
   virtual HRESULT ComputeTemporaryStrandFill(IPrecastGirder* girder, StrandIndexType nStrands, IIndexArray** strandFill) const = 0;
   ...
   virtual HRESULT GetNextNumberOfStraightStrands(IPrecastGirder* girder, StrandIndexType currNum,  StrandIndexType* nextStrands) const = 0;
   virtual HRESULT GetNextNumberOfHarpedStrands(IPrecastGirder* girder, StrandIndexType currNum,  StrandIndexType* nextStrands) const = 0;
   virtual HRESULT GetNextNumberOfTemporaryStrands(IPrecastGirder* girder, StrandIndexType currNum,  StrandIndexType* nextStrands) const = 0;
   virtual HRESULT GetPreviousNumberOfStraightStrands(IPrecastGirder* girder, StrandIndexType currNum,  StrandIndexType* prevStrands) const = 0;
   virtual HRESULT GetPreviousNumberOfHarpedStrands(IPrecastGirder* girder, StrandIndexType currNum,  StrandIndexType* prevStrands) const = 0;
   virtual HRESULT GetPreviousNumberOfTemporaryStrands(IPrecastGirder* girder, StrandIndexType currNum,  StrandIndexType* prevStrands) const = 0;

   // computations for total number of permanent strands
   virtual HRESULT GetMaxNumPermanentStrands(IPrecastGirder* girder, StrandIndexType* numStrands) const = 0;
   virtual HRESULT ComputeNumPermanentStrands(IPrecastGirder* girder, StrandIndexType totalPermanent, StrandIndexType* numStraight, StrandIndexType* numHarped) const = 0;
   virtual HRESULT GetNextNumberOfPermanentStrands(IPrecastGirder* girder, StrandIndexType currNum,  StrandIndexType* nextStrands) const = 0;
   virtual HRESULT GetPreviousNumberOfPermanentStrands(IPrecastGirder* girder, StrandIndexType currNum,  StrandIndexType* prevStrands) const = 0;
};
...
public:
   ...
   //       do not change it - clone it if you want to hang on to it.
   //       And, it becomes invalid after subsequent calls into this class
   virtual HRESULT ComputeStraightStrandFill(IPrecastGirder* girder, const CDirectStrandFillCollection* pCollection, IIndexArray** strandFill) const = 0;
   virtual HRESULT ComputeHarpedStrandFill(IPrecastGirder* girder, const CDirectStrandFillCollection* pCollection, IIndexArray** strandFill) const = 0;
   virtual HRESULT ComputeTemporaryStrandFill(IPrecastGirder* girder, const CDirectStrandFillCollection* pCollection, IIndexArray** strandFill) const = 0;
};
...
public:
   ...
   virtual HRESULT IsValidNumStraightStrands(IPrecastGirder* girder, StrandIndexType nStrands,VARIANT_BOOL* bIsValid) const override;
   ...
   virtual HRESULT IsValidNumHarpedStrands(IPrecastGirder* girder, StrandIndexType nStrands,VARIANT_BOOL* bIsValid) const override;
   ...
   virtual HRESULT IsValidNumTemporaryStrands(IPrecastGirder* girder, StrandIndexType nStrands,VARIANT_BOOL* bIsValid) const override;
   ...
   //       do not change it - clone it if you want to hang on to it.
   //       And, it becomes invalid after subsequent calls into this class
   virtual HRESULT ComputeStraightStrandFill(IPrecastGirder* girder, StrandIndexType nStrands, IIndexArray** strandFill) const override;
   ...
   virtual HRESULT ComputeHarpedStrandFill(IPrecastGirder* girder, StrandIndexType nStrands, IIndexArray** strandFill) const override;
   ...
   virtual HRESULT ComputeTemporaryStrandFill(IPrecastGirder* girder, StrandIndexType nStrands, IIndexArray** strandFill) const override;
   ...
   virtual HRESULT GetNextNumberOfStraightStrands(IPrecastGirder* girder, StrandIndexType currNum,  StrandIndexType* nextStrands) const override;
   virtual HRESULT GetNextNumberOfHarpedStrands(IPrecastGirder* girder, StrandIndexType currNum,  StrandIndexType* nextStrands) const override;
   virtual HRESULT GetNextNumberOfTemporaryStrands(IPrecastGirder* girder, StrandIndexType currNum,  StrandIndexType* nextStrands) const override;
   virtual HRESULT GetPreviousNumberOfStraightStrands(IPrecastGirder* girder, StrandIndexType currNum,  StrandIndexType* prevStrands) const override;
   virtual HRESULT GetPreviousNumberOfHarpedStrands(IPrecastGirder* girder, StrandIndexType currNum,  StrandIndexType* prevStrands) const override;
   virtual HRESULT GetPreviousNumberOfTemporaryStrands(IPrecastGirder* girder, StrandIndexType currNum,  StrandIndexType* prevStrands) const override;

   // computations for total number of permanent strands
   virtual HRESULT GetMaxNumPermanentStrands(IPrecastGirder* girder, StrandIndexType* numStrands) const override;
   virtual HRESULT ComputeNumPermanentStrands(IPrecastGirder* girder, StrandIndexType totalPermanent, StrandIndexType* numStraight, StrandIndexType* numHarped) const override;
   virtual HRESULT GetNextNumberOfPermanentStrands(IPrecastGirder* girder, StrandIndexType currNum,  StrandIndexType* nextStrands) const override;
   virtual HRESULT GetPreviousNumberOfPermanentStrands(IPrecastGirder* girder, StrandIndexType currNum,  StrandIndexType* prevStrands) const override;

   // CDirectStrandFiller implementations
   // NOTE: The strandFill array is for temporary use only - 
   //       do not change it - clone it if you want to hang on to it.
   //       And, it becomes invalid after subsequent calls into this class
   virtual HRESULT ComputeStraightStrandFill(IPrecastGirder* girder, const CDirectStrandFillCollection* pCollection, IIndexArray** strandFill) const override;
   virtual HRESULT ComputeHarpedStrandFill(IPrecastGirder* girder, const CDirectStrandFillCollection* pCollection, IIndexArray** strandFill) const override;
   virtual HRESULT ComputeTemporaryStrandFill(IPrecastGirder* girder, const CDirectStrandFillCollection* pCollection, IIndexArray** strandFill) const override;
