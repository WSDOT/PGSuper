...
void CLibraryEditorChildFrame::DoSetUnitsMode(libUnitsMode::Mode mode)
{
   CDocument* pdoc= GetActiveDocument();
   libISupportLibraryManager* plm = dynamic_cast<libISupportLibraryManager*>(pdoc);
   ASSERT(plm);
   plm->SetUnitsMode(mode);
}

libUnitsMode::Mode CLibraryEditorChildFrame::DoGetUnitsMode()
{
   CDocument* pdoc= GetActiveDocument();
   libISupportLibraryManager* plm = dynamic_cast<libISupportLibraryManager*>(pdoc);
   ASSERT(plm);
   return plm->GetUnitsMode();
}
