...
void CPluginManagerDlg::Init()
{
   ...
   m_ProjectImporterPage.m_psp.dwFlags |= PSP_USETITLE | PSP_HASHELP;
   ...
   m_ProjectImporterPage.m_psp.pszTitle = _T("Project Importers");
   ...
   m_ProjectImporterPage.Init(PROJECT_IMPORTER_PAGE);
