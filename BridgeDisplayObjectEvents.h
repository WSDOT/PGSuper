...
class CBridgeDisplayObjectEvents : public CCmdTarget
{
public:
   typedef enum ViewType
   {
	...
	CBridgeDisplayObjectEvents(IBroker* pDoc,CBridgeModelViewChildFrame* pFrame,iDisplayObject* pDO,ViewType viewType);
