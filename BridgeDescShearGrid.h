...
/////////////////////////////////////////////////////////////////////////////
// CGirderDescShearGrid window

class CGirderDescShearGrid : public CGXGridWnd
{
...
// Overrides
	...
	//{{AFX_VIRTUAL(CGirderDescShearGrid)
	//}}AFX_VIRTUAL

// Implementation
public:
	virtual ~CGirderDescShearGrid();

	// Generated message map functions
protected:
	//{{AFX_MSG(CGirderDescShearGrid)
