========================================================================
    ACTIVE TEMPLATE LIBRARY : WSDOTAgent Project Overview
========================================================================

AppWizard has created this WSDOTAgent project for you to use as the starting point for
...
WSDOTAgent.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (WSDOTAgent.h)
        GUID definitions                                (WSDOTAgent_i.c)
        A type library                                  (WSDOTAgent.tlb)
        Marshaling code                                 (WSDOTAgent_p.c and dlldata.c)

WSDOTAgent.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in WSDOTAgent.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named WSDOTAgent.pch and a precompiled types file named StdAfx.obj.
...
WSDOTAgentps.vcproj
	...
	dlldata.c, WSDOTAgent_i.c and WSDOTAgent_p.c which are required
