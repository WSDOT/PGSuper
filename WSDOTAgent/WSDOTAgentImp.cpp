...
bool CWSDOTAgentImp::Init()
{
   ...
   std::shared_ptr<WBFL::ReportMgr::ReportSpecificationBuilder> pGirderLineRptSpecBuilder( std::make_shared<CGirderLineReportSpecificationBuilder>(m_pBroker) );
   ...
   if ( pDocType->IsPGSuperDocument() )
   {
      ...
      std::shared_ptr<WBFL::ReportMgr::ReportBuilder> pRptBuilder(std::make_shared<WBFL::ReportMgr::ReportBuilder>(_T("WSDOT Girder Schedule")));
      ...
      pRptBuilder->AddChapterBuilder( std::shared_ptr<WBFL::ReportMgr::ChapterBuilder>(std::make_shared<CGirderScheduleChapterBuilder>()) );
      pRptMgr->AddReportBuilder( pRptBuilder );
   }

   // WSDOT Load Rating Summary
   std::shared_ptr<WBFL::ReportMgr::ReportBuilder> pRptBuilder(std::make_shared<WBFL::ReportMgr::ReportBuilder>(_T("WSDOT Load Rating Summary")));
#if defined _DEBUG || defined _BETA_VERSION
   pRptBuilder->IncludeTimingChapter();
#endif
   pRptBuilder->SetReportSpecificationBuilder( pGirderLineRptSpecBuilder );
   pRptBuilder->AddChapterBuilder( std::shared_ptr<WBFL::ReportMgr::ChapterBuilder>(std::make_shared<CLoadRatingSummaryChapterBuilder>()) );
   pRptMgr->AddReportBuilder( pRptBuilder );
