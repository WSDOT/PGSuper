...
class REPORTINGCLASS CBearingTimeStepDetailsReportSpecificationBuilder :
   public CBrokerReportSpecificationBuilder
{
public:
   CBearingTimeStepDetailsReportSpecificationBuilder(std::shared_ptr<WBFL::EAF::Broker> pBroker);
   ~CBearingTimeStepDetailsReportSpecificationBuilder(void);
