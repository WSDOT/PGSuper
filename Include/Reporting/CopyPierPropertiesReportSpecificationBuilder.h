...
class REPORTINGCLASS CCopyPierPropertiesReportSpecificationBuilder :
   public CBrokerReportSpecificationBuilder
{
public:
   CCopyPierPropertiesReportSpecificationBuilder(std::shared_ptr<WBFL::EAF::Broker> pBroker);
   ~CCopyPierPropertiesReportSpecificationBuilder(void);
