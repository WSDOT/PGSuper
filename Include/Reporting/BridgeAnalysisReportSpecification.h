...
{
public:
   CBridgeAnalysisReportSpecification(const std::_tstring& strReportName,std::shared_ptr<WBFL::EAF::Broker> pBroker,GirderIndexType gdrIdx,bool bDesign,bool bRating);
