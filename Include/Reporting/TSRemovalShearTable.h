...
class REPORTINGCLASS CTSRemovalShearTable
{
public:
   CTSRemovalShearTable();
   CTSRemovalShearTable(const CTSRemovalShearTable& rOther);
   virtual ~CTSRemovalShearTable();

   CTSRemovalShearTable& operator = (const CTSRemovalShearTable& rOther);
...
protected:
   void MakeCopy(const CTSRemovalShearTable& rOther);
   virtual void MakeAssignment(const CTSRemovalShearTable& rOther);
};
