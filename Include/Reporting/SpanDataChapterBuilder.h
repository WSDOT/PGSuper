...
#ifndef INCLUDED_SPANDATACHAPTERBUILDER_H_
#define INCLUDED_SPANDATACHAPTERBUILDER_H_
...
class REPORTINGCLASS CSpanDataChapterBuilder : public CPGSuperChapterBuilder
{
public:
   // GROUP: LIFECYCLE
...
#endif // INCLUDED_SPANDATACHAPTERBUILDER_H_
