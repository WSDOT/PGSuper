...
{
public:
   CSegmentReportSpecification(const std::_tstring& strReportName, std::shared_ptr<WBFL::EAF::Broker> pBroker, const CSegmentKey& segmentKey);
...
{
public:
   CGirderLineReportSpecification(const std::_tstring& strReportName, std::shared_ptr<WBFL::EAF::Broker> pBroker,GirderIndexType gdrIdx);
...
{
public:
   CMultiGirderReportSpecification(const std::_tstring& strReportName, std::shared_ptr<WBFL::EAF::Broker> pBroker,const std::vector<CGirderKey>& girderKeys);
...
public:
   ...
   CMultiViewSpanGirderReportSpecification(const std::_tstring& strReportName, std::shared_ptr<WBFL::EAF::Broker> pBroker,const std::vector<CGirderKey>& girderKeys);
...
{
public:
   CPointOfInterestReportSpecification(const std::_tstring& strReportName, std::shared_ptr<WBFL::EAF::Broker>pBroker,const pgsPointOfInterest& poi);
