...
class REPORTINGCLASS CTSRemovalRotationTable
{
public:
   CTSRemovalRotationTable();
   CTSRemovalRotationTable(const CTSRemovalRotationTable& rOther);
   virtual ~CTSRemovalRotationTable();

   CTSRemovalRotationTable& operator = (const CTSRemovalRotationTable& rOther);
...
protected:
   void MakeCopy(const CTSRemovalRotationTable& rOther);
   virtual void MakeAssignment(const CTSRemovalRotationTable& rOther);
};
