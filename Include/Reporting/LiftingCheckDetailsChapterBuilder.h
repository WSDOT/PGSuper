...
#ifndef INCLUDED_LIFTINGCHECKDETAILSCHAPTERBUILDER_H_
#define INCLUDED_LIFTINGCHECKDETAILSCHAPTERBUILDER_H_
...
public:
   // GROUP: LIFECYCLE
   CLiftingCheckDetailsChapterBuilder(bool bSelect = true);
...
#endif // INCLUDED_LIFTINGCHECKCHAPTERBUILDER_H_
