...
{
public:
   CLoadRatingReportSpecificationBuilder(std::shared_ptr<WBFL::EAF::Broker> pBroker);
...
{
public:
   CLoadRatingSummaryReportSpecificationBuilder(std::shared_ptr<WBFL::EAF::Broker> pBroker);
...
{
public:
   CGirderLoadRatingReportSpecification(const std::_tstring& strReportName, std::shared_ptr<WBFL::EAF::Broker> pBroker, const CGirderKey& gdrKey, bool bReportForAllPoi);
...
{
public:
   CGirderLineLoadRatingReportSpecification(const std::_tstring& strReportName, std::shared_ptr<WBFL::EAF::Broker> pBroker, GirderIndexType gdrIdx, bool bReportForAllPoi);
...
{
public:
   CMultiGirderLoadRatingReportSpecification(const std::_tstring& strReportName, std::shared_ptr<WBFL::EAF::Broker> pBroker, const std::vector<CGirderKey>& gdrKeys, bool bReportForAllPoi);
