...
CLASS 
   ...
   Encapsulates the construction of the tendon stress check table.
...
LOG
   rab : 09.12.2013 : Created file
*****************************************************************************/

class REPORTINGCLASS CTendonStressCheckTable
{
public:
   CTendonStressCheckTable();
   CTendonStressCheckTable(const CTendonStressCheckTable& rOther);
   virtual ~CTendonStressCheckTable();
