...
CLASS 
   ...
   in the ACI 209 document
*****************************************************************************/

class REPORTINGCLASS CACI209CreepCoefficientChapterBuilder : public CPGSuperChapterBuilder
{
public:
   CACI209CreepCoefficientChapterBuilder(bool bSelect=true);
