...
class REPORTINGCLASS CTimeStepDetailsReportSpecification :
   public CBrokerReportSpecification
{
public:
	CTimeStepDetailsReportSpecification(const std::_tstring& strReportName,std::shared_ptr<WBFL::EAF::Broker> pBroker,bool bReportAtAllLocations,const pgsPointOfInterest& poi,IntervalIndexType intervalIdx);
