...
class REPORTINGCLASS CLRFDTimeDependentCreepCoefficientChapterBuilder : public CPGSuperChapterBuilder
{
public:
   CLRFDTimeDependentCreepCoefficientChapterBuilder(bool bSelect=true);
