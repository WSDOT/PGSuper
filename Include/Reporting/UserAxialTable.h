...
class REPORTINGCLASS CUserAxialTable
{
public:
   // GROUP: LIFECYCLE
   ...
   //------------------------------------------------------------------------
   // Copy constructor
   CUserAxialTable(const CUserAxialTable& rOther);

   //------------------------------------------------------------------------
   // Destructor
   virtual ~CUserAxialTable();

   // GROUP: OPERATORS
   //------------------------------------------------------------------------
   // Assignment operator
   CUserAxialTable& operator = (const CUserAxialTable& rOther);
