...
private:
   ...
   CDistributionFactorSummaryChapterBuilder(const CDistributionFactorSummaryChapterBuilder&);
   CDistributionFactorSummaryChapterBuilder& operator=(const CDistributionFactorSummaryChapterBuilder&);
