...
class REPORTINGCLASS CInitialStrainAnalysisReportSpecificationBuilder :
   public CBrokerReportSpecificationBuilder
{
public:
   CInitialStrainAnalysisReportSpecificationBuilder(std::shared_ptr<WBFL::EAF::Broker> pBroker);
