...
private:
   // GROUP: DATA MEMBERS
   // GROUP: LIFECYCLE
   void Build(rptChapter* pChapter,pgsTypes::LimitState limitState,IBroker* pBroker,SpanIndexType span,GirderIndexType gdr,IDisplayUnits* pDispUnit,Uint16 level) const;
