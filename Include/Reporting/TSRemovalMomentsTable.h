...
class REPORTINGCLASS CTSRemovalMomentsTable
{
public:
   CTSRemovalMomentsTable();
   CTSRemovalMomentsTable(const CTSRemovalMomentsTable& rOther);
   virtual ~CTSRemovalMomentsTable();

   CTSRemovalMomentsTable& operator = (const CTSRemovalMomentsTable& rOther);
...
protected:
   void MakeCopy(const CTSRemovalMomentsTable& rOther);
   virtual void MakeAssignment(const CTSRemovalMomentsTable& rOther);
};
