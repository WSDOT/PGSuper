...
#ifndef INCLUDED_HAULINGCHECKCHAPTERBUILDER_H_
#define INCLUDED_HAULINGCHECKCHAPTERBUILDER_H_
...
class REPORTINGCLASS CHaulingCheckChapterBuilder : public CPGSuperChapterBuilder
{
public:
   // GROUP: LIFECYCLE
