...
CLASS 
   ...
   in the AASHTO LRFD document
*****************************************************************************/

class REPORTINGCLASS CLRFDTimeDependentShrinkageStrainChapterBuilder : public CPGSuperChapterBuilder
{
public:
   CLRFDTimeDependentShrinkageStrainChapterBuilder(bool bSelect=true);
