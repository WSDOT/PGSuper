///////////////////////////////////////////////////////////////////////
// PGSuper - Prestressed  SUPERstructure Design and Analysis
...
class REPORTINGCLASS CCopyTempSupportPropertiesReportSpecificationBuilder :
   public CBrokerReportSpecificationBuilder
{
public:
   CCopyTempSupportPropertiesReportSpecificationBuilder(std::shared_ptr<WBFL::EAF::Broker> pBroker);
