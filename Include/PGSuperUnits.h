...
inline CString FormatOffset(Float64 offset,const unitmgtLengthData& indirectMeasure,bool bIncludeUnitTag = true)
{
...
inline CString FormatScalar(Float64 value,const unitmgtScalar& indirectMeasure)
{
   sysNumericFormatTool format_tool(indirectMeasure.Format,indirectMeasure.Width,indirectMeasure.Precision);
   std::_tstring str = format_tool.AsString( value );
   CString strScalar;
...
inline CString FormatPercentage(Float64 value,bool bIncludeUnitTag = true)
{
...
inline CString FormatStation(const unitStationFormat& format,Float64 value)
{
