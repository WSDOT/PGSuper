...
namespace PGS
{
   namespace Beams
   {
      class BEAMSCLASS VoidedSlabDistFactorEngineer : public DistFactorEngineerImpl<VOIDEDSLAB_LLDFDETAILS>
      {
      public:
         VoidedSlabDistFactorEngineer(std::weak_ptr<WBFL::EAF::Broker> pBroker, StatusGroupIDType statusGroupID) :
