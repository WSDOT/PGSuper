...
namespace PGS
{
   namespace Beams
   {
      class IBeamFactory : public BeamFactory, public BeamFactorySingleton<IBeamFactory>
      {
      public:
         static std::shared_ptr<IBeamFactory> CreateInstance() { return std::shared_ptr<IBeamFactory>(new IBeamFactory()); }
