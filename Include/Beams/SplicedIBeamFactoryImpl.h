...
namespace PGS
{
   namespace Beams
   {
      class CSplicedIBeamFactory : public SplicedBeamFactory, public BeamFactorySingleton<CSplicedIBeamFactory>
      {
      public:
         static std::shared_ptr<CSplicedIBeamFactory> CreateInstance() { return std::shared_ptr<CSplicedIBeamFactory>(new CSplicedIBeamFactory()); }
      ...
      private:
         ...
         void DimensionAndPositionBeam(const BeamFactory::Dimensions& dimensions, Float64 Hg,Float64 Hbf,IPrecastBeam* pBeam) const;
      };
   };
};
