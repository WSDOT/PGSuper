...
namespace PGS
{
   namespace Beams
   {
      class SplicedIBeamFactory : public SplicedBeamFactory, public BeamFactorySingleton<SplicedIBeamFactory>
      {
      public:
         static std::shared_ptr<SplicedIBeamFactory> CreateInstance() { return std::shared_ptr<SplicedIBeamFactory>(new SplicedIBeamFactory()); }
