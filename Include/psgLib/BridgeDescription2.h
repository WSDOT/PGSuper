...
class PSGLIBCLASS CBridgeDescription2
{
public:
   CBridgeDescription2();
   ...
   // to start with arbitrary pier numbering. The functions below support this capability
...
private:
   ...
   Float64 m_AssumedExcessCamber; // assumed excess camber for entire bridge
   ...
   HRESULT LoadOldBridgeDescription(Float64 version,IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress);
