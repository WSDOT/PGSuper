...
class WBFL::Materials::PsStrand;

class PSGLIBCLASS CSegmentDuctData
{
public:
...
class PSGLIBCLASS CSegmentPTData
{
public:
   CSegmentPTData();
   ...
   const WBFL::Materials::PsStrand* m_pStrand = nullptr; // tendon strand type
