...
struct PSGLIBCLASS SlabOffsetCriteria
{
   ...
   pgsTypes::SlabOffsetRoundingMethod RoundingMethod = pgsTypes::sormRoundNearest;
   Float64 SlabOffsetTolerance = WBFL::Units::ConvertToSysUnits(0.25, WBFL::Units::Measure::Inch);
