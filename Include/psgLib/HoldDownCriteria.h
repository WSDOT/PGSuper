...
struct PSGLIBCLASS HoldDownCriteria
{
   ...
   bool operator!=(const HoldDownCriteria& other) const;
   bool Compare(const HoldDownCriteria& other, const SpecLibraryEntryImpl& impl, std::vector<std::unique_ptr<PGS::Library::DifferenceItem>>& vDifferences, bool bReturnOnFirstDifference) const;
