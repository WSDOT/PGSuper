...
class PSGLIBCLASS CSupportActivityBase
{
public:
...
class PSGLIBCLASS CErectPiersActivity : public CSupportActivityBase
{
protected:
...
class PSGLIBCLASS CCastClosureJointActivity : public CSupportActivityBase
{
public:
