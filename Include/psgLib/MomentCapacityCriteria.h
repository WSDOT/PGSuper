...
struct PSGLIBCLASS MomentCapacityCriteria
{
   ...
   bool Compare(const MomentCapacityCriteria& other, const SpecLibraryEntryImpl& impl, std::vector<std::unique_ptr<DifferenceItem>>& vDifferences,bool bReturnOnFirstDifference) const;
