...
*****************************************************************************/
class PSGLIBCLASS CDuctGeometry
{
public:
...
*****************************************************************************/
class PSGLIBCLASS CLinearDuctGeometry : public CDuctGeometry
{
public:
...
*****************************************************************************/
class PSGLIBCLASS CParabolicDuctGeometry : public CDuctGeometry
{
public:
   CParabolicDuctGeometry();
...
*****************************************************************************/
class PSGLIBCLASS COffsetDuctGeometry : public CDuctGeometry
{
public:
   COffsetDuctGeometry()
   { 
