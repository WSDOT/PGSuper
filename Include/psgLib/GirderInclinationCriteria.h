...
struct PSGLIBCLASS GirderInclinationCriteria
{
   bool bCheck = true;
   Float64 FS = 1.2;
   ...
   bool operator!=(const GirderInclinationCriteria& other) const;
   bool Compare(const GirderInclinationCriteria& other, const SpecLibraryEntryImpl& impl, std::vector<std::unique_ptr<PGS::Library::DifferenceItem>>& vDifferences, bool bReturnOnFirstDifference) const;
