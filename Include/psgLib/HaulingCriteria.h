...
struct PSGLIBCLASS KDOTHaulingCriteria
{
   ...
   bool Compare(const KDOTHaulingCriteria& other, std::vector<std::unique_ptr<DifferenceItem>>& vDifferences, bool bReturnOnFirstDifference) const;
...
struct PSGLIBCLASS WSDOTHaulingCriteria
{
   ...
   bool Compare(const WSDOTHaulingCriteria& other, WBFL::LRFD::BDSManager::Edition specEdition, std::vector<std::unique_ptr<DifferenceItem>>& vDifferences, bool bReturnOnFirstDifference) const;
   void Report(rptChapter* pChapter, std::shared_ptr<IEAFDisplayUnits> pDisplayUnits) const;
   void Save(WBFL::System::IStructuredSave* pSave) const;
   void Load(WBFL::System::IStructuredLoad* pLoad);
};
...
struct PSGLIBCLASS HaulingCriteria
{
   ...
   bool Compare(const HaulingCriteria& other, WBFL::LRFD::BDSManager::Edition specEdition, std::vector<std::unique_ptr<DifferenceItem>>& vDifferences,bool bReturnOnFirstDifference) const;
