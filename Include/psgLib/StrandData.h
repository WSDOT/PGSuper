...
class PSGLIBCLASS CDirectStrandFillInfo
{
public:
...
class PSGLIBCLASS CDirectStrandFillCollection 
{
public:
...
public:
   ...
   // use one of the LOCATION_xxx constant to access these arrays
...
private:
   ...
   // in favor of using a single harp point definition in CStrandData. This eliminates the possibility
...
public:
   ...
   HRESULT Load(IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress,Float64* pVersion);
	HRESULT Save(IStructuredSave* pStrSave,std::shared_ptr<IEAFProgress> pProgress);
