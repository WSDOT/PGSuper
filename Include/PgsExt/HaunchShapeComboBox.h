...
//   DDX_Control(pDX,IDC_BOUNDARY_CONDITION,m_cbHaunchShape);
//   DDX_CBItemData(pDX, IDC_BOUNDARY_CONDITION, m_HaunchShape);


class PGSEXTCLASS CHaunchShapeComboBox : public CComboBox
{
public:
   CHaunchShapeComboBox();
