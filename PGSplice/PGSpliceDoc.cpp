...
IMPLEMENT_DYNCREATE(CPGSpliceDoc, CDocument)

BEGIN_MESSAGE_MAP(CPGSpliceDoc, CDocument)
...
BEGIN_DISPATCH_MAP(CPGSpliceDoc, CDocument)
	//{{AFX_DISPATCH_MAP(CPGSpliceDoc)
...
BEGIN_INTERFACE_MAP(CPGSpliceDoc, CDocument)
	INTERFACE_PART(CPGSpliceDoc, IID_IPGSuper, Dispatch)
END_INTERFACE_MAP()
...
void CPGSpliceDoc::OnUpdateError(const CString& errorMsg)
{
   CString my_string = errorMsg;
   UpdateAllViews(0,HINT_UPDATEERROR,(CObject*)&my_string);
}

bool CPGSpliceDoc::IsAutoCalcEnabled() const
{
   return theApp.IsAutoCalcEnabled();
}

void CPGSpliceDoc::EnableAutoCalc(bool bEnable)
{
...
bool CPGSpliceDoc::IsDesignFlexureEnabled() const
{
   return theApp.IsDesignFlexureEnabled();
}

void CPGSpliceDoc::EnableDesignFlexure( bool bEnable )
{
   theApp.EnableDesignFlexure(bEnable);
}

bool CPGSpliceDoc::IsDesignShearEnabled() const
{
   return theApp.IsDesignShearEnabled();
}

void CPGSpliceDoc::EnableDesignShear( bool bEnable )
{
   theApp.EnableDesignShear(bEnable);
}

void CPGSpliceDoc::OnLibMgrChanged(psgLibraryManager* pNewLibMgr)
{
...
int CPGSpliceDoc::GetNumberOfLibraryManagers() const
{
   return 1;
}

libLibraryManager* CPGSpliceDoc::GetLibraryManager(int num)
{
   PRECONDITION( num == 0 );
   return &m_LibMgr;
}

libLibraryManager* CPGSpliceDoc::GetTargetLibraryManager()
{
   return &m_LibMgr;
}

void CPGSpliceDoc::SetUnitsMode(libUnitsMode::Mode mode)
{
...
libUnitsMode::Mode CPGSpliceDoc::GetUnitsMode() const
{
...
void CPGSpliceDoc::GetDocUnitSystem(IDocUnitSystem** ppDocUnitSystem)
{
   (*ppDocUnitSystem) = m_DocUnitSystem;
   (*ppDocUnitSystem)->AddRef();
}

HRESULT CPGSpliceDoc::GetBroker(IBroker** ppBroker)
{
   (*ppBroker) = m_pBroker;
   (*ppBroker)->AddRef();
   return S_OK;
...
pgsStatusCenter& CPGSpliceDoc::GetStatusCenter()
{
   return m_StatusCenter;
}

void CPGSpliceDoc::EditAlignmentDescription(int nPage)
{
...
void CPGSpliceDoc::EditBridgeDescription(int nPage)
{
   GET_IFACE(IRoadwayData,pAlignment);
...
bool CPGSpliceDoc::EditPierDescription(PierIndexType pierIdx, int nPage)
{
...
bool CPGSpliceDoc::EditSpanDescription(SpanIndexType spanIdx, int nPage)
{
   GET_IFACE(IBridgeDescription,pBridgeDesc);
   const CBridgeDescription* pBridge = pBridgeDesc->GetBridgeDescription();
...
bool CPGSpliceDoc::EditGirderDescription(SpanIndexType span,GirderIndexType girder, int nPage)
{
...
bool CPGSpliceDoc::EditPointLoad(CollectionIndexType loadIdx)
{
...
bool CPGSpliceDoc::EditDistributedLoad(CollectionIndexType loadIdx)
{
   GET_IFACE(IUserDefinedLoadData, pUserDefinedLoads);
...
bool CPGSpliceDoc::EditMomentLoad(CollectionIndexType loadIdx)
{
   GET_IFACE(IUserDefinedLoadData, pUserDefinedLoads);
...
void CPGSpliceDoc::EditGirderViewSettings(int nPage)
{
...
void CPGSpliceDoc::EditBridgeViewSettings(int nPage)
{
   CPGSuperApp* papp =(CPGSuperApp*) AfxGetApp();
...
BOOL CPGSpliceDoc::UpdateTemplates()
{
   CPGSuperApp* pApp =(CPGSuperApp*) AfxGetApp();
...
BOOL CPGSpliceDoc::OnNewDocument()
{
...
BOOL CPGSpliceDoc::OnImportDocument(UINT nID)
{
	if (!CDocument::OnNewDocument())
		return FALSE;
...
BOOL CPGSpliceDoc::OnExportDocument(UINT nID)
{
   // get the importer
   CPGSuperApp* pApp =(CPGSuperApp*) AfxGetApp();
...
void CPGSpliceDoc::InitProjectProperties()
{
   CPGSuperApp* pApp =(CPGSuperApp*) AfxGetApp();
...
BOOL CPGSpliceDoc::OnOpenDocument(LPCTSTR lpszPathName) 
{
   CWaitCursor cursor;
...
BOOL CPGSpliceDoc::OpenTheDocument(LPCTSTR lpszPathName)
{
   HRESULT hr = S_OK;
...
long CPGSpliceDoc::ConvertTheDocument(LPCTSTR lpszPathName, CString* prealFileName)
{
...
BOOL CPGSpliceDoc::OnSaveDocument(LPCTSTR lpszPathName) 
{
...
/*--------------------------------------------------------------------*/
BOOL CPGSpliceDoc::SaveTheDocument(LPCTSTR lpszPathName)
{
   HRESULT hr = S_OK;
   CComQIPtr<IBrokerPersist,&IID_IBrokerPersist> pPersist( m_pBroker );
   ASSERT( pPersist );
...
/////////////////////////////////////////////////////////////////////////////
// CPGSpliceDoc serialization

void CPGSpliceDoc::Serialize(CArchive& ar)
{
...
BOOL CPGSpliceDoc::LoadAgents(IBrokerInitEx2* pBrokerInit, CLSID* pClsid, long nClsid)
{
   long lErrIndex = 0;
...
void CPGSpliceDoc::OnFileProjectProperties() 
{
   GET_IFACE( IProjectProperties, pProjProp );
   CPGSuperApp* pApp =(CPGSuperApp*) AfxGetApp();
...
void CPGSpliceDoc::HandleOpenDocumentError( HRESULT hr, LPCTSTR lpszPathName )
{
   GET_IFACE( IProjectLog, pLog );
...
void CPGSpliceDoc::HandleSaveDocumentError( HRESULT hr, LPCTSTR lpszPathName )
{
   GET_IFACE( IProjectLog, pLog );
...
void CPGSpliceDoc::HandleConvertDocumentError( HRESULT hr, LPCTSTR lpszPathName )
{
   GET_IFACE( IProjectLog, pLog );
...
void CPGSpliceDoc::OnProjectUnits() 
{
   CUnitsDlg dlg;
...
void CPGSpliceDoc::SetUnitMode(pgsTypes::UnitMode unitsMode)
{
   GET_IFACE(IProjectSettings,pProjSettings);
...
pgsTypes::UnitMode CPGSpliceDoc::GetUnitMode() const
{
   GET_IFACE(IProjectSettings,pProjSettings);
   return pProjSettings->GetUnitsMode();
}

void CPGSpliceDoc::OnSiUnits()
{
   SetUnitMode( pgsTypes::umSI );
}

void CPGSpliceDoc::OnUpdateSiUnits(CCmdUI* pCmdUI)
{
   pCmdUI->SetRadio( GetUnitMode() == pgsTypes::umSI );
}

void CPGSpliceDoc::OnUsUnits()
{
   SetUnitMode( pgsTypes::umUS );
}

void CPGSpliceDoc::OnUpdateUsUnits(CCmdUI* pCmdUI)
{
   pCmdUI->SetRadio( GetUnitMode() == pgsTypes::umUS );
}

void CPGSpliceDoc::OnProjectEnvironment() 
{
   GET_IFACE( IEnvironment, pEnvironment );
...
/*--------------------------------------------------------------------*/
void CPGSpliceDoc::OnProjectBridgeDesc() 
{
   EditBridgeDescription(0); // open to first page
}

/*--------------------------------------------------------------------*/
void CPGSpliceDoc::OnProjectSpec() 
{
...
/*--------------------------------------------------------------------*/
void CPGSpliceDoc::OnProjectAutoCalc() 
{
	EnableAutoCalc( !IsAutoCalcEnabled() );
}

/*--------------------------------------------------------------------*/
void CPGSpliceDoc::OnUpdateProjectAutoCalc(CCmdUI* pCmdUI) 
{
...
/*--------------------------------------------------------------------*/
void CPGSpliceDoc::OnExportToTemplateFile() 
{
...
bool CPGSpliceDoc::DoTxDotCadReport(const CString& outputFileName, const CString& errorFileName, const CPGSuperCommandLineInfo& txInfo)
{
...
void CPGSpliceDoc::OnUpdateStatusCenter(CCmdUI* pCmdUI)
{
   CString str;
...
void CPGSpliceDoc::OnViewStatusCenter(UINT nID)
{
...
void CPGSpliceDoc::OnViewsettingsBridgemodelEditor() 
{
   EditBridgeViewSettings(0);
}

void CPGSpliceDoc::OnViewsettingsGirderEditor() 
{
   EditGirderViewSettings(0);
}


void CPGSpliceDoc::OnLoadsLoadModifiers() 
{
...
void CPGSpliceDoc::SetModifiedFlag(BOOL bModified)
{
...
void CPGSpliceDoc::UpdateAnalysisTypeStatusIndicator()
{
   GET_IFACE(ISpecification,pSpec);
   CMainFrame* pMainFrame = (CMainFrame*)AfxGetMainWnd();
...
void CPGSpliceDoc::OnProjectDesignGirder() 
{
...
void CPGSpliceDoc::OnUpdateProjectDesignGirderDirect(CCmdUI* pCmdUI)
{
   pCmdUI->Enable( m_CurrentSpanIdx != ALL_SPANS && m_CurrentGirderIdx != ALL_GIRDERS );
}

void CPGSpliceDoc::OnUpdateProjectDesignGirderDirectHoldSlabOffset(CCmdUI* pCmdUI)
{
   GET_IFACE(ISpecification,pSpecification);
   GET_IFACE(IBridge,pBridge);
...
void CPGSpliceDoc::OnProjectDesignGirderDirect()
{
   GET_IFACE(ISpecification,pSpecification);
   GET_IFACE(IBridge,pBridge);
   bool bDesignSlabOffset = pSpecification->IsSlabOffsetDesignEnabled() && pBridge->GetDeckType() != pgsTypes::sdtNone;
...
void CPGSpliceDoc::OnProjectDesignGirderDirectHoldSlabOffset()
{
   DesignGirderDirect(false);
}

void CPGSpliceDoc::DesignGirderDirect(bool bDesignSlabOffset)
{
   if ( GetStatusCenter().GetSeverity() == pgsTypes::statusError )
   {
      AfxMessageBox("There are errors that must be corrected before you can design a girder\r\n\r\nSee the Status Center for details.",MB_OK);
...
void CPGSpliceDoc::DoDesignGirder(SpanIndexType span,GirderIndexType gdr,const arDesignOptions& designOptions)
{
   GET_IFACE(IArtifact,pIArtifact);
...
void CPGSpliceDoc::SaveFlexureDesign(SpanIndexType span,GirderIndexType gdr,const arDesignOptions& designOptions,const pgsDesignArtifact* pArtifact)
{
   GET_IFACE(IGirderData,pGirderData);
...
void CPGSpliceDoc::OnCloseDocument() 
{
...
void CPGSpliceDoc::DeleteContents()
{
   ...
   if ( m_TheRealBroker )
   {
      ...
      ASSERT( cRef == 0 );
      WATCH("~CPGSpliceDoc - Broker Ref Count = " << cRef);
   }

}

bool CPGSpliceDoc::LoadMasterLibrary()
{
...
bool CPGSpliceDoc::DoLoadMasterLibrary(const CString& strMasterLibaryFile)
{
...
PierIndexType CPGSpliceDoc::GetPierIdx()
{
   return m_CurrentPierIdx;
}

SpanIndexType CPGSpliceDoc::GetSpanIdx()
{
   return m_CurrentSpanIdx;
}

GirderIndexType CPGSpliceDoc::GetGirderIdx()
{
   return m_CurrentGirderIdx;
}

void CPGSpliceDoc::SelectPier(PierIndexType pierIdx)
{
...
void CPGSpliceDoc::SelectSpan(SpanIndexType spanIdx)
{
...
void CPGSpliceDoc::SelectGirder(SpanIndexType spanIdx,GirderIndexType gdrIdx)
{
   m_CurrentSpanIdx   = spanIdx;
...
void CPGSpliceDoc::OnCopyGirderProps() 
{
...
void CPGSpliceDoc::OnApplyCopyGirder(SpanGirderHashType fromHash,std::vector<SpanGirderHashType> toHash,BOOL bGirder,BOOL bTransverse,BOOL bLongitudinalRebar,BOOL bPrestress,BOOL bHandling, BOOL bMaterial, BOOL bSlabOffset)
{
...
void CPGSpliceDoc::OnImportProjectLibrary() 
{
...
void CPGSpliceDoc::OnLoadsLldf(pgsTypes::DistributionFactorMethod method,LldfRangeOfApplicabilityAction roaAction) 
{
   GET_IFACE(IBridgeDescription,pIBridgeDesc);
   const CBridgeDescription* pOldBridgeDesc = pIBridgeDesc->GetBridgeDescription();
...
void CPGSpliceDoc::OnStatusItemAdded(pgsStatusItem* pItem)
{
...
void CPGSpliceDoc::OnStatusItemRemoved(long id)
{
   CWnd* pWnd = AfxGetMainWnd();
   CMainFrame* pFrame = (CMainFrame*)(pWnd);
   pFrame->UpdateStatusBar();
...
void CPGSpliceDoc::OnAddPointload() 
{
...
/*-------------------------------------------------------------------*/
void CPGSpliceDoc::OnAddDistributedLoad() 
{
...
void CPGSpliceDoc::OnAddMomentLoad() 
{
...
void CPGSpliceDoc::OnProjectAlignment() 
{
   EditAlignmentDescription(0);
}

void CPGSpliceDoc::OnLiveLoads() 
{
   GET_IFACE( ILibraryNames, pLibNames );
...
void CPGSpliceDoc::OnReport(UINT nID)
{
...
void CPGSpliceDoc::OnQuickReport(UINT nID)
{
   // User picked a report from a menu.
...
void CPGSpliceDoc::OnViewAnalysisResults()
{
   CMainFrame* pFrame = (CMainFrame*)AfxGetMainWnd();
   pFrame->CreateAnalysisResultsView();
}

void CPGSpliceDoc::OnProjectAnalysis() 
{
...
void CPGSpliceDoc::DeletePier(PierIndexType pierIdx)
{
   // deleting a pier
...
void CPGSpliceDoc::DeleteSpan(SpanIndexType spanIdx)
{
   // deleting a span
...
void CPGSpliceDoc::DeletePier(PierIndexType pierIdx,pgsTypes::PierFaceType face)
{
...
void CPGSpliceDoc::DeleteSpan(SpanIndexType spanIdx,pgsTypes::RemovePierType pierRemoveType)
{
...
void CPGSpliceDoc::OnUndo() 
{
   GET_IFACE(ITransactions,pTransactions);
   pTransactions->Undo();
}

void CPGSpliceDoc::OnUpdateUndo(CCmdUI* pCmdUI) 
{
   GET_IFACE(ITransactions,pTransactions);
   
   if ( pTransactions->CanUndo() )
   {
      pCmdUI->Enable(TRUE);
      CString strCommand;
      strCommand.Format("Undo %s\tCtrl+Z",pTransactions->UndoName().c_str());
...
void CPGSpliceDoc::OnRedo() 
{
   GET_IFACE(ITransactions,pTransactions);
   ASSERT( pTransactions->CanRedo() );
   pTransactions->Redo();
}

void CPGSpliceDoc::OnUpdateRedo(CCmdUI* pCmdUI) 
{
   GET_IFACE(ITransactions,pTransactions);
   
   if ( pTransactions->CanRedo() )
   {
      pCmdUI->Enable(TRUE);
      CString strCommand;
      strCommand.Format("Redo %s\tCtrl+Y",pTransactions->RedoName().c_str());
      pCmdUI->SetText(strCommand);
   }
   else
   {
...
void CPGSpliceDoc::InsertSpan(PierIndexType refPierIdx,pgsTypes::PierFaceType pierFace)
{
...
void CPGSpliceDoc::OnOptionsHints() 
{
   CString strText;
...
void CPGSpliceDoc::OnOptionsLabels() 
{
...
void CPGSpliceDoc::PopulateReportMenu()
{
...
int CPGSpliceDoc::FindMenuItem(CMenu* pParentMenu,const char* strTargetMenu)
{
...
UINT_PTR CPGSpliceDoc::GetReportCommand(CollectionIndexType rptIdx,bool bQuickReport)
{
...
CollectionIndexType CPGSpliceDoc::GetReportIndex(UINT nID,bool bQuickReport)
{
   UINT baseID = IDM_REPORT;
   if ( !bQuickReport )
   {
