...
CStatusCenterDlg::CStatusCenterDlg(pgsStatusCenter& statusCenter)
...
void CStatusCenterDlg::OnStatusItemAdded(pgsStatusItem* pNewItem)
{
   CListCtrl* pListCtrl = (CListCtrl*)GetDlgItem(IDC_STATUSLIST);

   long severity = m_StatusCenter.GetSeverity(pNewItem->GetCallbackID());
...
LRESULT CStatusCenterDlg::OnCommandHelp(WPARAM, LPARAM lParam)
{
   ::HtmlHelp( *this, AfxGetApp()->m_pszHelpFilePath, HH_HELP_CONTEXT, IDH_STATUS_CENTER_VIEW );
   return TRUE;
}
