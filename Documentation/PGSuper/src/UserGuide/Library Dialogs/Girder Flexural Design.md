...
Maximum debonded strands per section | These values limit the number of strands that can be debonded at a given longitudinal location. Starting with LRFD 9th Edition, there is a maximum number of debonded strands per section for girders with 10 or fewer debonded strands and a maximum number for all other cases. In LRFD 8th Edition and earlier, the limit on the number of strands that could be debonded was a number of strands (4) but the total number of debonded strands was constrained to a percentage of the total number of strands (40%). The 8th Edition (and earlier) and 9th Edition (and later) requirements can be modeled. The LRFD 10th Edition add separate limit for 0.7" diameter strands. The 0.7" diameter strand limit will be used regardless of the LRFD specification edition. | B | 4
