...
Horizontal Transverse Tie | Check the horizontal transverse tie requirements per LRFD 5.9.4.4.3. The tie force is always computed, however if this option is unselected it does not factor into the specification check results.
