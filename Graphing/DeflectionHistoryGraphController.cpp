...
IMPLEMENT_DYNCREATE(CDeflectionHistoryGraphController,CEAFGraphControlWindow)
...
BEGIN_MESSAGE_MAP(CDeflectionHistoryGraphController, CEAFGraphControlWindow)
...
CGirderKey CDeflectionHistoryGraphController::GetGirderKey()
{
   return m_GirderKey;
}

pgsPointOfInterest CDeflectionHistoryGraphController::GetLocation()
{
   return m_Poi;
}

void CDeflectionHistoryGraphController::OnGroupChanged()
{
...
void CDeflectionHistoryGraphController::OnGirderChanged()
{
...
void CDeflectionHistoryGraphController::OnLocationChanged()
{
   // Get the new poi
...
void CDeflectionHistoryGraphController::OnXAxis()
{
   UpdateGraph();
}

void CDeflectionHistoryGraphController::FillGroupCtrl()
{
   CComboBox* pcbGroup = (CComboBox*)GetDlgItem(IDC_GROUP);
   int curSel = pcbGroup->GetCurSel();
...
void CDeflectionHistoryGraphController::FillGirderCtrl()
{
   CComboBox* pcbGirder = (CComboBox*)GetDlgItem(IDC_GIRDER);
   int curSel = pcbGirder->GetCurSel();
...
void CDeflectionHistoryGraphController::FillLocationCtrl()
{
   CComboBox* pcbLocation = (CComboBox*)GetDlgItem(IDC_POI);
   int curSel = pcbLocation->GetCurSel();
...
int CDeflectionHistoryGraphController::GetXAxisType()
{
