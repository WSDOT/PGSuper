...
CGraphColor::CGraphColor(IndexType nGraphs)
{
   Init();
   SetGraphCount(nGraphs);
}

void CGraphColor::Init()
{
...
void CGraphColor::SetGraphCount(IndexType nGraphs)
{
   m_nGraphs = nGraphs;
   ComputeColorParameters();
}

void CGraphColor::SetHueRange(Float64 minHue,Float64 maxHue)
{
   m_MinHue = minHue;
   m_MaxHue = maxHue;
   ComputeColorParameters();
...
void CGraphColor::SetSaturation(Float64 saturation)
{
   m_Saturation = saturation;
   ComputeColorParameters();
}

void CGraphColor::SetLightness(Float64 lightness)
{
   m_Lightness = lightness;
   ComputeColorParameters();
}

void CGraphColor::SetColorPerBandCount(IndexType nColorsPerBand)
{
   m_ColorsPerBand = nColorsPerBand;
   ComputeColorParameters();
}

COLORREF CGraphColor::GetColor(IndexType graphIndex)
{
