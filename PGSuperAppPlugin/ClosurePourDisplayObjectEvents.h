...
// ClosurePourDisplayObjectEvents.h : header file
//
...
/////////////////////////////////////////////////////////////////////////////
// CClosurePourDisplayObjectEvents command target

class CClosurePourDisplayObjectEvents : public CCmdTarget
{
public:
	CClosurePourDisplayObjectEvents(const CSegmentKey& closureKey,const CSegmentKey& leftSegmentKey,const CSegmentKey& rightSegmentKey,CBridgeModelViewChildFrame* pFrame);
...
protected:
   ...
   void EditClosurePour(iDisplayObject* pDO);
   void SelectClosurePour(iDisplayObject* pDO);
   void SelectPrev(iDisplayObject* pDO);
   void SelectNext(iDisplayObject* pDO);
   void SelectPrevAdjacent(iDisplayObject* pDO);
   void SelectNextAdjacent(iDisplayObject* pDO);
};
