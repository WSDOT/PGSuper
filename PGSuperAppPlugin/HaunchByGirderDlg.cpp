...
CHaunchByGirderDlg::~CHaunchByGirderDlg()
{
}

void CHaunchByGirderDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
}


BEGIN_MESSAGE_MAP(CHaunchByGirderDlg, CDialog)
END_MESSAGE_MAP()

BOOL CHaunchByGirderDlg::OnInitDialog()
{
...
void CHaunchByGirderDlg::UploadData(const HaunchInputData& rData)
{
