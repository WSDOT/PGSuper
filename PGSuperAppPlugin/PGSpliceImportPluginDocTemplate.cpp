...
CPGSpliceImportPluginDocTemplate::~CPGSpliceImportPluginDocTemplate()
{
}

CPGSProjectImporterMgrBase* CPGSpliceImportPluginDocTemplate::CreateProjectImporterMgr() const
{
   return new CPGSpliceProjectImporterMgr;
}
