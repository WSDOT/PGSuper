...
// ClosureJointDisplayObjectEvents.h : header file
//
...
class CClosureJointDisplayObjectEvents : public CCmdTarget
{
public:
...
protected:
   ...
   void EditClosureJoint(iDisplayObject* pDO);
   void SelectClosureJoint(iDisplayObject* pDO);
