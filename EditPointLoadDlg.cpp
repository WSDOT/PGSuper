...
CEditPointLoadDlg::CEditPointLoadDlg(CPointLoadData load, IBroker* pBroker, CWnd* pParent /*=NULL*/):
...
{
   const unitForce& usForce = unitMeasure::Kip;
   const unitForce& siForce = unitMeasure::Kilonewton;
...
void CEditPointLoadDlg::UpdateStageLoadCase(bool isInitial)
{
...
void CEditPointLoadDlg::UpdateGirderList()
{
   ...
   Int32 nGirders = nMaxGirders;

   for (Int32 gdrIdx = 0; gdrIdx < nGirders; gdrIdx++)
   {
      CString str;
