...
// Look at the implementation of pgsLoadRater carfully. There are several structs defined in the header file
...
void pgsLoadRater::SetBroker(std::shared_ptr<WBFL::EAF::Broker> pBroker)
{
   m_pBroker = pBroker;
}
