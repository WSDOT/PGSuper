...
private:
   ...
   // GROUP: OPERATORS
   // GROUP: OPERATIONS
   void AnalyzeHauling(SpanIndexType span,GirderIndexType gdr,bool bUseConfig,const HANDLINGCONFIG& config,IGirderHaulingDesignPointsOfInterest* pPOId,pgsWsdotHaulingAnalysisArtifact* pArtifact);
   void PrepareHaulingAnalysisArtifact(SpanIndexType span,GirderIndexType gdr,Float64 Loh,Float64 Roh,Float64 Fc,Float64 Ec,pgsTypes::ConcreteType concType,pgsWsdotHaulingAnalysisArtifact* pArtifact);
   ...
   void ComputeHaulingFsForCracking(SpanIndexType span,GirderIndexType gdr,
                                    ...
                                    const std::vector<Float64>& momVec,
                                    pgsWsdotHaulingAnalysisArtifact* pArtifact);
   void ComputeHaulingFsForRollover(SpanIndexType span,GirderIndexType gdr,pgsWsdotHaulingAnalysisArtifact* pArtifact);
